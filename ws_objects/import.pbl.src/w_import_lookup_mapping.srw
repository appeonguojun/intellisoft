...
DataStore ids_LookUpTableData[5]
...
li_Return = ln_getfilename.of_getopenfilename("Select File", ls_DocPath, ls_DocName, "TXT", "Text Files (*.TXT),*.TXT")
...
if CurrentRow > 0 then
	...
	// Set DDDW visible
	if ls_map_type = "F" or ls_map_type = "M" or ls_map_type = "I" or IsNull(ls_map_type) then
		this.object.lookup_table_dddw.visible = '0'
	else
		this.object.lookup_table_dddw.visible = '1'
	end if
