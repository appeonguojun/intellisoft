...
dw_step.object.step_desc[4] = "4. Import data into ContractLogix table"
...
public function integer of_setimportprocessdesc (string as_description);string ls_Text

if Len(as_Description) > 0 then
	ls_Text = "4. Import data into ContractLogix table ---> " + as_Description + "..."
else
	ls_Text = "4. Import data into ContractLogix table"
end if
...
event closequery;if not cb_close.Enabled then Return 1
end event
