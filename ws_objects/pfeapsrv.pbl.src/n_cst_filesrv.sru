...
public subroutine of_runfile (string as_filename);String ls_ext,ls_null
...
Choose Case Upper(ls_ext)
	Case 'HTML','HTM'
		ShellExecuteA ( Handle( w_mdi ), "open", 'IEXPLORE', as_filename , ls_Null, 4)	
	Case Else
...
public function integer of_filesaveas (string as_sourcefile, boolean ab_open);string ls_path, ls_file,ls_ext,ls_filetype
int li_rc,li_pos
...
li_rc = ln_getfilename.of_getsavefilename( "Select File", ls_path, ls_file, ls_ext, &
	      ls_filetype + " Files (*." + Upper(ls_ext) + "),*."+ Upper(ls_ext) )
...
public function string of_getfileversion (string as_filename);//Return of_getfileinfo(as_filename, 'FileVersion')
...
public function string of_getfiletypedes (string as_filename);//as_filename : file name or file ext name
...
public function long of_genfilesize (long al_size, ref string as_unit);//////////////////////////////////////////////////////////////////////
// $<function>n_cst_filesrvof_genfilesize()
// $<arguments>
//		value    	long	al_size		
...
//Modified by gavins 20161125 ,  beacuse decimal convert to long equal 0 in pb, web isnot 
//////////////////////////////////////////////////////////////////////
