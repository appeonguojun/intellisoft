...
sle_to.Text = Mid(ls_send_to,1,Len(ls_send_to)-2)
end subroutine
...
ids_message_board.SetItem(ll_row,'send_to_roles',Mid(is_send_to_roles,1,Len(is_send_to_roles)-2))
ids_message_board.SetItem(ll_row,'send_to_users',Mid(is_send_to_users,1,Len(is_send_to_users)-2))
