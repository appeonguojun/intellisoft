...
Choose Case as_tag
	...
	Case '8' //manage_users
		w_mdi.event pfc_cst_security_user_painter()
...
For i = 1 To UpperBound(apb_module[])
	...
	Choose Case ls_id
		Case '1' //add_new_contract
			//Modified By Ken.Guo 08/28/2013
...
//			If w_mdi.of_security_access( 2070 ) = 2 and (w_mdi.of_security_access( 6955 ) = 1 or w_mdi.of_security_access( 6988 ) = 1 ) Then //New CTX or use Template
			If w_mdi.of_security_access( 2070 ) = 2 and (w_mdi.of_security_access( 6955 ) >= 1 or w_mdi.of_security_access( 6988 ) = 1 ) Then //Modified By Jay Chen 06-25-2014
