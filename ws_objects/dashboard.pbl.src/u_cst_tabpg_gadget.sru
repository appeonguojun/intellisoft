...
//Added By Gavins 04-29-2016 add '  ' before selectedtab text when select the tab
if AppeonGetClientType() = 'WEB' then 
	string ls_text
	ls_text = Trim( This.text )
   	This.Text ='      ' + ls_text + '    ' //Modified By Jay 2016-05-23  before 6 spaces and after 4 spaces for tab text 
 end if
