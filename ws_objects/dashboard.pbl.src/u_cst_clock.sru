...
type variables
Long il_hour_length = 80
Long il_minute_length = 120
Long il_second_length = 120
...
li_hour = Long(Mid(ls_time,1,2))
If li_hour >= 12 Then li_hour = li_hour - 12

li_minute = Long(Mid(ls_time,3,2))
li_second = Long(Mid(ls_time,5,2))
...
If st_time.text <> String(lt_now,'HH:mm') Then
	st_time.text = String(lt_now,'HH:mm')
End If
