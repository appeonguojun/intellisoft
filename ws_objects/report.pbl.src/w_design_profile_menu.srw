...
FOR i = 1 TO w_prac_profile_design.uo_design.ii_obj_select_cnt
	...
	IF Right( w_prac_profile_design.uo_design.is_last_object[i], 2) =  "_t" THEN
...
IF Pos(w_prac_profile_design.uo_design.is_last_object[1], "object" ) > 0 THEN
	ls_obj_id = Mid(w_prac_profile_design.uo_design.is_last_object[1], 7,100)
