...
long backcolor = 67108864
string text = "which the login user has permission to view. "
...
long textcolor = 33554432
long backcolor = 67108864
string text = "If it is selected, the running result of Reports/Graphs and Rpt Writer only contains the contracts "
boolean focusrectangle = false
end type
