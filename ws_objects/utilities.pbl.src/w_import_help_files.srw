...
long backcolor = 67108864
boolean enabled = false
string text = "1) Click Get Help Files to go to the ContractLogix Group website.  "
boolean focusrectangle = false
end type
...
//+ docname, named, "DOC", &
//	+ "text Files (*.txt),*.txt")			//Added By Mark Lee 08/15/2014
...
n_getfilename     ln_getfilename
value = ln_getfilename.of_getopenfilename("Select File",&
                + dbfname, named, "TXT", "text Files (*.txt),*.txt")
