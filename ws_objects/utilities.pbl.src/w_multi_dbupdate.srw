$PBExportHeader$w_multi_dbupdate.srw
forward
global type w_multi_dbupdate from window
end type
type cb_2 from commandbutton within w_multi_dbupdate
end type
type cb_export from commandbutton within w_multi_dbupdate
end type
type cb_1 from commandbutton within w_multi_dbupdate
end type
type dw_filter from datawindow within w_multi_dbupdate
end type
type st_2 from statictext within w_multi_dbupdate
end type
type st_1 from statictext within w_multi_dbupdate
end type
type dw_cache from datawindow within w_multi_dbupdate
end type
type cb_select from commandbutton within w_multi_dbupdate
end type
type cb_close from commandbutton within w_multi_dbupdate
end type
type cb_save from commandbutton within w_multi_dbupdate
end type
type cb_delete from commandbutton within w_multi_dbupdate
end type
type cb_add from commandbutton within w_multi_dbupdate
end type
type cb_ping from commandbutton within w_multi_dbupdate
end type
type rb_runafter from radiobutton within w_multi_dbupdate
end type
type rb_runnow from radiobutton within w_multi_dbupdate
end type
type cb_viewlog from commandbutton within w_multi_dbupdate
end type
type cb_import from commandbutton within w_multi_dbupdate
end type
type rb_byselect from radiobutton within w_multi_dbupdate
end type
type rb_byask from radiobutton within w_multi_dbupdate
end type
type gb_1 from groupbox within w_multi_dbupdate
end type
type gb_2 from groupbox within w_multi_dbupdate
end type
type gb_3 from groupbox within w_multi_dbupdate
end type
end forward
...
global w_multi_dbupdate w_multi_dbupdate
...
// Function: w_multi_dbupdate.f_isselectrow()
//--------------------------------------------------------------------
...
// Function: w_multi_dbupdate.f_button_enable()
//--------------------------------------------------------------------
...
//Function: w_multi_dbupdate.f_get_update_parameter()
//--------------------------------------------------------------------
...
// Function: w_multi_dbupdate.f_set_update_parameter()
//--------------------------------------------------------------------
...
// Function: w_multi_dbupdate.f_connect_db()
//--------------------------------------------------------------------
...
public function integer f_start_update ();
//==============================APPEON BEGIN==========================
// Function: w_multi_dbupdate.f_start_update()
//--------------------------------------------------------------------
...
FOR ll_rowcount = 1 To dw_cache.RowCount()
	IF dw_cache.Object.cache_selected[ll_rowcount] = 1 THEN
		...
		IF f_connect_db(ls_dbparm,ls_DBMS,ll_rowcount,1) = 1 THEN
			...
			sleep(3) //Added By Ken.Guo 2015-08-04
		END IF
	END IF
NEXT
...
public function integer f_update_result (long arg_rownumber, long arg_cache_id);
//==============================APPEON BEGIN==========================
// Event: w_multi_dbupdate.f_update_result()
//--------------------------------------------------------------------
...
// Function: w_multi_dbupdate.f_get_result()
//--------------------------------------------------------------------
...
// Function: w_multi_dbupdate.f_refresh_filter()
//--------------------------------------------------------------------
...
IF CC_tansobject.SQLCode <> 0 THEN
	...
	IF IsValid(w_multi_dbupdate) THEN Close(w_multi_dbupdate)
...
gnv_app.of_window_basic_code(this) //Added By Ken.Guo 2016-03-17
 ...
 //Added By Ken.Guo 2017-08-01
cb_select.Text = '&Deselect All'
cb_select.event clicked( )
dw_cache.resetupdate( )


end event

event closequery;//==============================APPEON BEGIN==========================
// Event: closequery.w_multi_dbupdate()
//--------------------------------------------------------------------
...
If ib_SQLCA_UsedOLE Then
	Messagebox('ContractLogix','Please quit contractlogix and run again.',Exclamation! )
End If
end event
...
openwithparm( w_multi_dbupdate_screen_para, '' )
...
//==============================APPEON END============================
 ...
 //Added By Ken.Guo 2017-08-01. support multi select
Long ll_start, ll_end, ll_step, i
If Keydown(KeyShift!) and row > 0 Then
	ll_start = This.GetRow()
	If ll_start = 0 Then ll_start = 1
	If ll_start < row Then
		ll_end = row
	Else
		ll_end = ll_start
		ll_start = row
...
IF ll_InsertRow <> -1 THEN
	SELECT Top 1 @@version  Into :ls_dbtype From ids using sqlca;
	IF Pos(Upper(ls_dbtype) , 'SQL SERVER') > 0 THEN
		dw_cache.Object.cache_type[ll_InsertRow] = '1'
	ELSE
		dw_cache.Object.cache_type[ll_InsertRow] = '0'
	END IF
	dw_cache.Object.cache_selected[ll_InsertRow] = 1	
	dw_cache.ScrollToRow(ll_InsertRow)		
	dw_cache.SetRow(ll_InsertRow)
END IF
