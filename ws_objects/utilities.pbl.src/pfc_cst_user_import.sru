...
//	li_rtn = GetFileOpenName("Select Import File",    docpath, docname, "TXT",  "Text Files (*.TXT),*.TXT," )			//Added By Mark Lee 08/15/2014
	n_getfilename     ln_getfilename
	li_rtn = ln_getfilename.of_getopenfilename("Select Import File",    docpath, docname, "TXT",  "Text Files (*.TXT),*.TXT," )	
