$PBExportHeader$w_clause_email_users.srw
forward
global type w_clause_email_users from w_popup
end type
type cbx_appointment from checkbox within w_clause_email_users
end type
type st_tips from statictext within w_clause_email_users
end type
type cb_ic from commandbutton within w_clause_email_users
end type
type cb_cancel from commandbutton within w_clause_email_users
end type
type cb_ok from commandbutton within w_clause_email_users
end type
type dw_1 from u_dw_contract within w_clause_email_users
end type
end forward
...
global w_clause_email_users w_clause_email_users
...
on w_clause_email_users.create
int iCurrent
call super::create
...
on w_clause_email_users.destroy
call super::destroy
...
istr_alarm_user = message.powerobjectparm	
dw_1.SetTransObject(SQLCA)
dw_1.Retrieve()

dw_1.Modify("create_action.visible = '0'")
dw_1.Modify("create_appointment.visible = '0'")
dw_1.modify("email_id.width = 1300")
dw_1.modify("user_id.width = 450")
