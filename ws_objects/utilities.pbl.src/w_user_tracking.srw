...
type dw_opened_doc from u_dw within tabpage_4
end type
type tabpage_4 from userobject within tab_1
dw_opened_doc dw_opened_doc
end type
type tab_1 from tab within w_user_tracking
tabpage_1 tabpage_1
tabpage_2 tabpage_2
...
ElseIf tab_1.selectedtab = 4 Then //Added By Ken.Guo 2016-04-05
	tab_1.tabpage_4.dw_opened_doc.event pfc_retrieve()
End If
end event
...
integer height = 1648
long backcolor = 79741120
string text = "Online Opened Documents"
long tabtextcolor = 33554432
long tabbackcolor = 79741120
long picturemaskcolor = 536870912
dw_opened_doc dw_opened_doc
...
on tabpage_4.create
this.dw_opened_doc=create dw_opened_doc
this.Control[]={this.dw_opened_doc}
end on

on tabpage_4.destroy
destroy(this.dw_opened_doc)
end on
...
integer height = 1632
integer taborder = 20
string dataobject = "d_opened_doc"
boolean hscrollbar = true
end type

event constructor;call super::constructor;//Added By Ken.Guo 2016-04-05
This.of_setupdateable(False)
This.of_setrowselect(True)
This.of_setsort(True)
This.inv_sort.of_SetColumnHeader(TRUE)
