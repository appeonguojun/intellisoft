...
long textcolor = 128
long backcolor = 67108864
string text = "Solution: 1. new version after 12.2.1015.13 has this issue fixed.     2. execute the following repair button which will place a red X image in the picture objects with this issue for screens in all views. The user can select new image for objects that display this image to fix the issue."
