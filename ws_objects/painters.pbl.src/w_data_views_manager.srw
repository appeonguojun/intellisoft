...
integer width = 2981
integer height = 2180
string title = "Practitioner Data View Painter"
...
if ll_ModifiedCount > 0 then
	li_Return = MessageBox("ContractLogix", "Do you want to save changes?", Exclamation!, YesNoCancel!)
	if li_Return = 1 then
		uo_views_manager.cb_1.Event Clicked()
