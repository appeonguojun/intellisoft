...
//GetFileOpenName ( "Select File", path, filename, "ISG", "ISG Files (*.isg),*.isg")		//Added By Mark Lee 08/15/2014
n_getfilename     ln_getfilename
ln_getfilename.of_getopenfilename ( "Select File", path, filename, "ISG", "ISG Files (*.isg),*.isg")

gf_save_dir_path(path) //Added by Ken.Guo on 2009-03-10
