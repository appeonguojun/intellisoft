...
type cb_1 from u_cb within pfc_cst_u_views_manager
end type
...
type cb_3 from u_cb within pfc_cst_u_views_manager
end type
...
public function integer of_add_screen (integer ai_screen_id, integer ai_cr)
...
FOR i = 1 TO li_rc
	...
	dw_selected_dump.Setitem(i , as_filter_field, Left( li_filter_fld_data, Len( 	li_filter_fld_data  ) - 4))  
END FOR
...
public function integer of_add_screen (integer ai_screen_id, integer ai_cr);Integer li_selected_last_row
...
//copy report data
of_copy_report_data(li_copy_view)
