$PBExportHeader$w_lookup_maint_clean_up_lookups.srw
forward
global type w_lookup_maint_clean_up_lookups from w_main
end type
type dw_detail from u_dw within w_lookup_maint_clean_up_lookups
end type
type gb_1 from groupbox within w_lookup_maint_clean_up_lookups
end type
type dw_name from u_dw within w_lookup_maint_clean_up_lookups
end type
type cb_new_lookup from u_cb within w_lookup_maint_clean_up_lookups
end type
type cb_add from u_cb within w_lookup_maint_clean_up_lookups
end type
type cb_delete from u_cb within w_lookup_maint_clean_up_lookups
end type
type cb_save from u_cb within w_lookup_maint_clean_up_lookups
end type
type cb_close from u_cb within w_lookup_maint_clean_up_lookups
end type
type cb_sort from u_cb within w_lookup_maint_clean_up_lookups
end type
type cb_filter from u_cb within w_lookup_maint_clean_up_lookups
end type
type cb_print from u_cb within w_lookup_maint_clean_up_lookups
end type
type cb_saveas from u_cb within w_lookup_maint_clean_up_lookups
end type
type dw_1 from datawindow within w_lookup_maint_clean_up_lookups
end type
type cb_1 from commandbutton within w_lookup_maint_clean_up_lookups
end type
type dw_change_to from datawindow within w_lookup_maint_clean_up_lookups
end type
type st_1 from statictext within w_lookup_maint_clean_up_lookups
end type
type sle_1 from singlelineedit within w_lookup_maint_clean_up_lookups
end type
type sle_2 from singlelineedit within w_lookup_maint_clean_up_lookups
end type
type st_2 from statictext within w_lookup_maint_clean_up_lookups
end type
type st_3 from statictext within w_lookup_maint_clean_up_lookups
end type
end forward
...
global w_lookup_maint_clean_up_lookups w_lookup_maint_clean_up_lookups
...
event open;call super::open;SQLCA.DBMS="ODBC"
...
on w_lookup_maint_clean_up_lookups.create
int iCurrent
call super::create
...
this.dw_change_to=create dw_change_to
...
this.Control[iCurrent+15]=this.dw_change_to
...
on w_lookup_maint_clean_up_lookups.destroy
call super::destroy
...
event clicked;dw_detail.SaveAs( "", Text!, True )
//restore Directory  
...
boolean bringtotop = true
string dataobject = "d_lookup_table_fields"
