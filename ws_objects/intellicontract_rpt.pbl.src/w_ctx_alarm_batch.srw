...
Boolean ib_readonly //Added By Ken.Guo 2015-09-18
...
public function datetime of_get_datevalue (long al_ctx_id, long al_doc_id, long al_level_id1, long al_level_id2, string as_alm_table, string as_alm_column)
public subroutine of_set_button_status ()
end prototypes
...
of_set_button_status() //Added By Ken.Guo 2015-09-18
...
If of_gettabpagevisible(ls_tabname,true) Then //and w_Mdi.of_security_access(2090)  = 2 Then
	If isvalid(iw_appeon_gifofwait) Then
	...
	If of_gettabpagevisible(ls_tabname,false) Then //and w_Mdi.of_security_access(2091)  = 2 Then 
	...
	If of_gettabpagevisible(ls_tabname,false) Then //and w_Mdi.of_security_access(2093)  = 2 Then 
		ls_Text = of_GetTabpageText(ls_tabname) //use tab name replace screen titlebar text
		ll_screen_id = 10
		ltvi_Item = ltvi_Item_null
		ltvi_Item.PictureIndex = 3
...
If of_gettabpagevisible(ls_tabname,true) Then //and w_Mdi.of_security_access(2220)  = 2 Then
	If isvalid(iw_appeon_gifofwait) Then
...
If of_gettabpagevisible(ls_tabname,true) and of_gettabpagevisible('tabpage_dm_workflow',false) Then //and w_Mdi.of_security_access(2150)  = 2  and w_Mdi.of_security_access(6935) = 2 Then //documet manager main tab and Work flow sub tab
	If isvalid(iw_appeon_gifofwait) Then
...
If of_gettabpagevisible(ls_tabname,true) Then // and w_Mdi.of_security_access(2160) = 2 Then //
	If isvalid(iw_appeon_gifofwait) Then
...
If of_gettabpagevisible(ls_tabname,true) Then //and w_Mdi.of_security_access(2170)  = 2 Then
	If isvalid(iw_appeon_gifofwait) Then
...
For i = 1 To ll_cnt
	...
	ldt_date = of_get_datevalue(astr_alarm[i].ctx_id, astr_alarm[i].doc_id, astr_alarm[i].level_id1, astr_alarm[i].level_id2, astr_alarm[i].alm_table, astr_alarm[i].alm_column)
	dw_alm_det.SetItem(1, 'alm_date' ,ldt_date )
...
public function datetime of_get_datevalue (long al_ctx_id, long al_doc_id, long al_level_id1, long al_level_id2, string as_alm_table, string as_alm_column);//====================================================================
// Function: of_get_datevalue
//--------------------------------------------------------------------
// Description: Get column's date value with alarm data.
//--------------------------------------------------------------------
// Arguments:
//                al_ctx_id
//                al_doc_id
...
Datetime ldt_datevalue

 DECLARE cur_up_getdatevalue PROCEDURE FOR up_get_alarm_datevalue  
			:al_ctx_id,
			:al_doc_id,
			:al_level_id1,
			:al_level_id2,
...
Execute cur_up_getdatevalue;

if SQLCA.sqlcode = 0 then
	FETCH cur_up_getdatevalue INTO :ldt_datevalue;
Else
	gnv_debug.of_output(True, 'Failed to get alarm date. up_get_column_datetime. ' + sqlca.sqlerrtext )
End If

Close cur_up_getdatevalue;

Return ldt_datevalue

end function

public subroutine of_set_button_status ();//====================================================================
// Function: of_set_button_status
//--------------------------------------------------------------------
// Description:
//--------------------------------------------------------------------
// Arguments:
...
this.Control[iCurrent+1]=this.cbx_min
this.Control[iCurrent+2]=this.cb_refresh
this.Control[iCurrent+3]=this.cb_report
this.Control[iCurrent+4]=this.tv_datefields
this.Control[iCurrent+5]=this.st_unalarm_cnt
this.Control[iCurrent+6]=this.st_ctx_cnt
this.Control[iCurrent+7]=this.rb_not
...
this.Control[iCurrent+12]=this.cb_default
this.Control[iCurrent+13]=this.cb_ok
this.Control[iCurrent+14]=this.cb_cancel
this.Control[iCurrent+15]=this.dw_alm_det
this.Control[iCurrent+16]=this.gb_1
this.Control[iCurrent+17]=this.ole_message
...
If w_mdi.of_security_access(2070)  <> 2 Then
	ib_readonly = True
	of_set_button_status()
	dw_alm_det.enabled = False
	dw_alm_msg.enabled = False
...
//		ll_Rtn = GetFileOpenName("Select File", ls_PathName, ls_FileName, "DOC", "All Files (*.*), *.*")
	...
	CASE 'b_attach2' //Added By Jay Chen 09-14-2015
	...
	CASE 'b_attach3' //Added By Jay Chen 09-14-2015
...

