...
public function integer of_generate_miss_info_letter (integer ai_facility_ids[], long al_prac_ids[], long al_rec_ids[], datawindow adw);//this object is no longer used//maha using pfc_cst_u_generate_miss_info_rqst_apb
n_ds lds_miss_data
