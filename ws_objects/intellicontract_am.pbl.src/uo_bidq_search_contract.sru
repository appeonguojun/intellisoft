...
type pb_1 from u_tabpg_contract_search`pb_1 within uo_bidq_search_contract
end type

type pb_2 from u_tabpg_contract_search`pb_2 within uo_bidq_search_contract
end type

type pb_3 from u_tabpg_contract_search`pb_3 within uo_bidq_search_contract
end type

type pb_4 from u_tabpg_contract_search`pb_4 within uo_bidq_search_contract
end type

type sle_page from u_tabpg_contract_search`sle_page within uo_bidq_search_contract
end type

type uo_page from u_tabpg_contract_search`uo_page within uo_bidq_search_contract
end type
