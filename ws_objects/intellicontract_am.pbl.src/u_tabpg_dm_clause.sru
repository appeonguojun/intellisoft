...
long il_num = 0,il_last_handle,il_handle[] //Added By Jay Chen 04-23-2014
long il_draghandle //Added By Jay Chen 04-23-2014
end variables
...
do while ll_find_clause > 0 
	...
	l_tvi_clause.selectedpictureindex = 3 //Modified By Jay Chen 04-23-2014
...
/*************
//Get current selected folder or clause id //Modified By Jay Chen 04-23-2014
...
il_draghandle = NewHandle //Added By Jay Chen 04-23-2014
...
event clicked;call super::clicked;/********************Modified By Jay Chen 04-23-2014
//For Clause Comparison functionality - Added by Alfee 10.18.2007
...
event dragleave;call super::dragleave;//Added By Jay Chen 04-23-2014
...
//			tv_1.setitem(il_draghandle,l_tvi)
	...
	else //Added By Jay Chen 04-23-2014
		if l_tvi.data <> -1 then  //second level folder
//			if l_tvi.StatePictureIndex = 1 then
//				l_tvi.StatePictureIndex = 2
//				tv_1.setitem(il_draghandle,l_tvi)
