...
type dw_pend_clause from datawindow within w_dm_add_clause
end type
...
public function integer of_set_selected_clauses (long al_docid, decimal adc_revision)
end prototypes
...
long ll_pend_clause,ll_pend_folder
datetime ldt_modify_date
string ls_clause_name

//Added By Jay Chen 01-28-2014
tab_1.tabpage_1.ds_clause_included.reset()
IF dw_pend_clause.rowcount() <=0 then
	messagebox("Information","Please select at least one clause. ")
	return
end if

//Modified By Jay Chen 04-23-2014
for i = 1 to dw_pend_clause.rowcount()
	ll_pend_folder = dw_pend_clause.getitemnumber(i, "folder_id")
	ll_pend_clause = dw_pend_clause.getitemnumber(i, "clause_id")
	ls_clause_name = dw_pend_clause.getitemstring(i, "clause_name")
	ldt_modify_date = dw_pend_clause.getitemdatetime(i, "modify_date")
	il_clause_id = ll_pend_clause
	ii_folder_id = ll_pend_folder
	is_clause_name = ls_clause_name
	idt_modify_date = ldt_modify_date
...
//				MessageBox( 'Tips', 'The selected clause can not be used because it does not comply with the clause rules. ' )
				MessageBox( 'Tips', "The selected clause [" + ls_clause_name  +"] can not be used because it does not comply with the clause rules. " ) //Modified By Jay Chen 04-23-2014
				Return
...
//			tab_1.tabpage_1.ds_clause_included.reset() //Modified By Jay Chen 04-23-2014
...
string ls_rights
long li_row,ll_num1,ll_num2,ll_selected_clauseid[],ll_find_select,ll_clause_temp //Added By Jay Chen 04-23-2014
string ls_clause_name //Added By Jay Chen 04-24-2014

ll_row = dw_selected.getrow()
if ll_row < 1 then return 

//Modified By Jay Chen 04-24-2014
if dw_selected.rowcount() < 1 then return
for li_row = dw_selected.rowcount() to 1 step -1
	if dw_selected.isselected(li_row) then 
		ll_clause_temp = dw_selected.object.ctx_acp_clause_id[li_row]
		//ignore remove operation if not authorized(without full access or adding with approval right)
		ll_find = ids_clause_rights.find("ctx_acp_clause_id = " + string(ll_clause_temp),1,ids_clause_rights.rowcount())
		if ll_find > 0 then
			ls_rights = ids_clause_rights.getitemstring(ll_find,"rights")
			if ls_rights <> '21' and ls_rights <> '25' then 
				ls_clause_name = dw_selected.object.clause_name[li_row]
				messagebox("Alert", "Sorry! You don't have rights to remove the clause [" + ls_clause_name + "]!")
				return
			end if
		end if
		ll_selected_clauseid[upperbound(ll_selected_clauseid) + 1] = ll_clause_temp
	end if
next

for li_row = 1 to upperbound(ll_selected_clauseid) //Added By Jay Chen 04-24-2014
	ll_selected_clause = ll_selected_clauseid[li_row]
	...
	if dw_selected.rowcount() > 0 then
		...
		if ll_find >0 then 
			if ll_num2 < 1 then
				...
				if messagebox("Delete Clause","Are you sure want to delete this clause from the document?" &
						,Question!,YesNo!,1) = 2 then //cancel
					dw_selected.setredraw(true)
					ib_refresh = true //restore to refresh the dispaly of clause files
					return 
...
if of_get_clause_file(ll_clause_id,ldt_modify_date) = -1 then 
	messagebox("ContractLogix","Can't finish adding clause(s) to document due to getting clause file(s) failed!" )
	return -1
end if
...
//Modified By Ken.Guo 2016-04-08. change ai_docid to  al_docid. should use long Arg type.
//////////////////////////////////////////////////////////////////////
...
for i = 1 to ll_cnt
	...
	dw_selected.setitem(i,"doc_id",al_docid)
...
int iCurrent
call super::create
this.dw_pend_clause=create dw_pend_clause
...
this.Control[iCurrent+1]=this.dw_pend_clause
...
this.Control[iCurrent+8]=this.cb_move_left
this.Control[iCurrent+9]=this.cb_move_right
...
IF IsValid(gw_contract) THEN
	...
	if istr_pass.w_parent_window.classname() <> 'w_documents_browse' then //Added By Jay Chen 09-17-2014 setfocus to document browse when w_documents_browse is active
...
string title = "none"
string dataobject = "dw_wait_insert_clause"
...
event clicked;this.DragIcon = "row.ico"
...

