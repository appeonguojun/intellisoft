...
event activate;If this.visible = false Then Return  //Added By Ken.Guo 2015-09-24. workaround crash issue.
...
If uo_1.is_show_activate_app <> "1" Or uo_1.is_show_activate_per <> "1"  Then	
	//If gs_imageview_version = '5.0' and isvalid(uo_1.tab_1.tabpage_preview.ole_doc ) Then
	If  gs_imageview_version = '5.0' and isvalid(uo_1.inv_dm_comparison) Then
		uo_1.tab_1.tabpage_preview.ole_doc.object.activate(true)
	End If
End If
...
uo_1.tab_1.tabpage_preview.ole_doc.of_close() //Added By Ken.Guo 2015-09-24. workaround PB crash bug.
...
If uo_1.il_prior_notify_doc_id > 0 Then
	gnv_tracking.of_tracking_doc( gnv_tracking.document_management,string(uo_1.il_prior_notify_doc_id),'','','','delete_doc_tracking',false )
End If
...
//If IsValid( uo_1.inv_ole_utils_doc ) Then //Added By Jay 2017-01-18
//	uo_1.inv_ole_utils_doc.Of_Activate(false)
//End If
end event
