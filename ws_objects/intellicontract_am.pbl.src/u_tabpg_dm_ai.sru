...
ls_es_fileid = ldw_current.GetItemString(ll_row,'es_fileid')	 //Modified By Jay Chen 04-30-2014
...
Else
	...
	If ll_row > 0 Then
		...
		If ll_actiontype > 0 and (ll_actiontype = gnv_sertifi.il_esign or ll_actiontype = gnv_echosign.il_esign or ll_actiontype = gnv_docusign.il_esign) Then //Modified By Jay Chen 10-15-2013
...
event getfocus;call super::getfocus;//Added By Ken.Guo 2016-05-16. jump focus to other column. to workaround issue.
