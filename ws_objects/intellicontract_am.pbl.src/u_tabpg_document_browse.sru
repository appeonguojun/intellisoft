...
datastore ids_search //Added By Jay Chen 04-02-2014
...
event type integer ue_search();// 7.8.2016 <RP> - new method to perform retrieval with arguments
//
// Returns:
//	1 - Success
//	-1 - Error
//
// 7.8.2016 - Initial version by Ronnie Po
// 7.18.2016 - Added "style" retrieval arguments corresponding to custom_1 ... custom_10
//
// Observe the same general steps as ue_retrieve()
//
datawindow ldw_filter, ldw_browse
long ll_ret
string ls_readonly_flag = "N"
long ll_ctx_id
// Added 7.18.2016
integer li_ix
...
//Determine whether user has read-only rights to Documents Browse Module
...
IF ldw_filter.rowCount() = 0 THEN
	return -1
ELSEIF ldw_filter.acceptText() <> 1 THEN
	return -1
END IF

//gnv_appeondb.of_startqueue( )

// NOTE: ctx_id has an editmask, so empty string translates to 0 instead of NULL
//ll_ctx_id = ldw_filter.object.ctx_id[1]
//IF ll_ctx_id = 0 THEN setNull(ll_ctx_id)

// 7.18.2016 - send edit style to SP
FOR li_ix = 1 TO 10
	ls_edit_style[li_ix] = ldw_filter.describe("custom_" + string(li_ix) + ".Edit.Style")
NEXT

//ll_ret = ldw_browse.Retrieve ( &
//	gs_user_id, &
//	ls_readonly_flag, &
//	ll_ctx_id, &
//	ldw_filter.object.doc_id[1], &
//	ldw_filter.object.doc_name[1], &
//	ldw_filter.object.doc_ext[1], &
//	ldw_filter.object.doc_type[1], &
//	ldw_filter.object.status[1], &
//	ldw_filter.object.createby[1], &
//	ldw_filter.object.company_name[1], &
//	ldw_filter.object.checkout_by[1], &
//	ldw_filter.object.doc_category[1], &
//	ldw_filter.object.checkout_status[1], &
//	ls_edit_style[1], &
//	ls_edit_style[2], &
//	ls_edit_style[3], &
//	ls_edit_style[4], &
...
//	ls_edit_style[9], &
//	ls_edit_style[10], &
//	ldw_filter.object.custom_1[1], &
//	ldw_filter.object.custom_2[1], &
//	ldw_filter.object.custom_3[1], &
//	ldw_filter.object.custom_4[1], &
//	ldw_filter.object.custom_5[1], &
//	ldw_filter.object.custom_6[1], &
//	ldw_filter.object.custom_7[1], &
//	ldw_filter.object.custom_8[1], &
//	ldw_filter.object.custom_9[1], &
//	ldw_filter.object.custom_10[1], &
//	ldw_filter.object.custom_n1[1], &
//	ldw_filter.object.custom_n2[1], &
//	ldw_filter.object.custom_n3[1], &
//	ldw_filter.object.custom_n4[1], &
//	ldw_filter.object.custom_n5[1], &
//	ldw_filter.object.custom_n6[1], &
//	ldw_filter.object.custom_n7[1], &
//	ldw_filter.object.custom_n8[1], &
//	ldw_filter.object.custom_n9[1], &
//	ldw_filter.object.custom_n10[1], &
//	ldw_filter.object.custom_date1[1], &
//	ldw_filter.object.custom_date2[1], &
//	ldw_filter.object.custom_date3[1], &
//	ldw_filter.object.custom_date4[1], &
//	ldw_filter.object.custom_date5[1], &
//	ldw_filter.object.custom_date6[1] &
//)
//Added By Ken.Guo 2016-07-12
Long ll_doc_id,ll_status,ll_doc_category
String ls_doc_name,ls_doc_ext,ls_createby,ls_company_name,ls_checkout_by,ls_checkout_status,ls_doc_type
String ls_custom_1,ls_custom_2, ls_custom_3, ls_custom_4, ls_custom_5,ls_custom_6, ls_custom_7, ls_custom_8,ls_custom_9,ls_custom_10
Decimal{2}  ll_custom_n1,ll_custom_n2, ll_custom_n3, ll_custom_n4, ll_custom_n5, ll_custom_n6, ll_custom_n7, ll_custom_n8, ll_custom_n9, ll_custom_n10
Datetime ldt_custom_date1, ldt_custom_date2, ldt_custom_date3, ldt_custom_date4,ldt_custom_date5, ldt_custom_date6

ldw_filter.accepttext()
If ldw_filter.rowcount() > 0 Then
//	ll_ctx_id =	ldw_filter.object.ctx_id[1]
	ll_ctx_id = ldw_filter.object.ctx_id[1]
	IF ll_ctx_id = 0 THEN setNull(ll_ctx_id)
	
	ll_doc_id =	ldw_filter.object.doc_id[1]
	ls_doc_name =	ldw_filter.object.doc_name[1]
	ls_doc_ext =	ldw_filter.object.doc_ext[1]
	ls_doc_type =	ldw_filter.object.doc_type[1]
	ll_status =	ldw_filter.object.status[1]
	ls_createby =	ldw_filter.object.createby[1]
	ls_company_name =	ldw_filter.object.company_name[1]
	ls_checkout_by =	ldw_filter.object.checkout_by[1]
	ll_doc_category=	ldw_filter.object.doc_category[1]
	ls_checkout_status =	ldw_filter.object.checkout_status[1]
	ls_custom_1 =	ldw_filter.object.custom_1[1]
	ls_custom_2=	ldw_filter.object.custom_2[1]
	ls_custom_3=	ldw_filter.object.custom_3[1]
	ls_custom_4=	ldw_filter.object.custom_4[1]
	ls_custom_5=	ldw_filter.object.custom_5[1]
	ls_custom_6=	ldw_filter.object.custom_6[1]
	ls_custom_7=	ldw_filter.object.custom_7[1]
	ls_custom_8=	ldw_filter.object.custom_8[1]
	ls_custom_9=	ldw_filter.object.custom_9[1]
	ls_custom_10=	ldw_filter.object.custom_10[1]
	ll_custom_n1 = ldw_filter.object.custom_n1[1]
	ll_custom_n2 = 	ldw_filter.object.custom_n2[1]
	ll_custom_n3 = 	ldw_filter.object.custom_n3[1]
	ll_custom_n4 = 	ldw_filter.object.custom_n4[1]
	ll_custom_n5 = 	ldw_filter.object.custom_n5[1]
	ll_custom_n6 = 	ldw_filter.object.custom_n6[1]
	ll_custom_n7 = 	ldw_filter.object.custom_n7[1]
	ll_custom_n8 = 	ldw_filter.object.custom_n8[1]
	ll_custom_n9 = 	ldw_filter.object.custom_n9[1]
	ll_custom_n10 = 	ldw_filter.object.custom_n10[1]
	
	//Modified By Ken.Guo 2016-10-17
//	ldt_custom_date1 =	ldw_filter.object.custom_date1[1]
//	ldt_custom_date2 =	ldw_filter.object.custom_date2[1]
//	ldt_custom_date3 =	ldw_filter.object.custom_date3[1]
//	ldt_custom_date4 =	ldw_filter.object.custom_date4[1]
//	ldt_custom_date5 =	ldw_filter.object.custom_date5[1]
//	ldt_custom_date6 =	ldw_filter.object.custom_date6[1] 
	ldt_custom_date1 =	ldw_filter.getitemdatetime(1, 'custom_date1')
	ldt_custom_date2 =	ldw_filter.getitemdatetime(1, 'custom_date2')
	ldt_custom_date3 =	ldw_filter.getitemdatetime(1, 'custom_date3')
	ldt_custom_date4 =	ldw_filter.getitemdatetime(1, 'custom_date4')
	ldt_custom_date5 =	ldw_filter.getitemdatetime(1, 'custom_date5')
	ldt_custom_date6 =	ldw_filter.getitemdatetime(1, 'custom_date6')
...
ll_ret = ldw_browse.Retrieve(&
		gs_user_id,ls_readonly_flag, ll_ctx_id,ll_doc_id,ls_doc_name,ls_doc_ext,ls_doc_type,ll_status,ls_createby,ls_company_name,ls_checkout_by,ll_doc_category,ls_checkout_status,&
		ls_edit_style[1],ls_edit_style[2], ls_edit_style[3], ls_edit_style[4],ls_edit_style[5], ls_edit_style[6], ls_edit_style[7], ls_edit_style[8], ls_edit_style[9], ls_edit_style[10],&
		ls_custom_1,ls_custom_2,ls_custom_3,ls_custom_4,ls_custom_5,ls_custom_6,ls_custom_7,ls_custom_8,ls_custom_9,ls_custom_10,&
		ll_custom_n1,ll_custom_n2,ll_custom_n3,ll_custom_n4,ll_custom_n5,ll_custom_n6,ll_custom_n7,ll_custom_n8,ll_custom_n9,ll_custom_n10,&
		ldt_custom_date1,ldt_custom_date2,ldt_custom_date3,ldt_custom_date4,ldt_custom_date5,ldt_custom_date6)
//	tab_1.tabpage_browse.dw_browse.Retrieve(gs_user_id)

//-------------------------------------------------------------------------------------------
// <RP> 7.10.2016 - Following logic has been moved to the stored procedure
...
//----------------------------------------------------------------------------------------
// <RP> 7.14.2016
// Redirect to ue_search()
return this.event ue_search()
//----------------------------------------------------------------------------------------
...
//----------------------------------------------------------------------------------------------------------------------------
// 7.9.2016 <RP>  - skip: test new DW objects
of_create_document_dw()
// END 7.9.2016 <RP>  - skip: test new DW objects
//----------------------------------------------------------------------------------------------------------------------------
...
event ue_set_resize;call super::ue_set_resize;// <RP> 7.10.2016 - Attempted to implement PFC resize service, but resize event of dw_browse has been overridden
// to bypass PFC resize service

//u_dw ldw_browse
//
//ldw_browse = tab_1.tabpage_browse.dw_browse
//ldw_browse.of_setResize(TRUE)
//ldw_browse.inv_resize.of_setOrigSize(ldw_browse.inv_resize.of_getWidth(), ldw_browse.height)
////ldw_browse.inv_resize.of_register("ctx_id", 0, 0, 0, 0)
//ldw_browse.inv_resize.of_register("facility_name", 0, 0, 25, 0)
//ldw_browse.inv_resize.of_register("facility_name_t", 0, 0, 25, 0)
//ldw_browse.inv_resize.of_register("doc_name_full", 25, 0, 75, 0)
//ldw_browse.inv_resize.of_register("doc_name_full_t", 25, 0, 75, 0)
//ldw_browse.inv_resize.of_register("doc_ext", 100, 0, 0, 0)
//ldw_browse.inv_resize.of_register("doc_ext_t", 100, 0, 0, 0)
//ldw_browse.inv_resize.of_register("doc_type", 100, 0, 0, 0)
//ldw_browse.inv_resize.of_register("doc_type_t", 100, 0, 0, 0)
//ldw_browse.inv_resize.of_register("category", 100, 0, 0, 0)
//ldw_browse.inv_resize.of_register("category_t", 100, 0, 0, 0)
//ldw_browse.inv_resize.of_register("status", 100, 0, 0, 0)
//ldw_browse.inv_resize.of_register("status_t", 100, 0, 0, 0)
//ldw_browse.inv_resize.of_register("create_by", 100, 0, 0, 0)
//ldw_browse.inv_resize.of_register("create_by_t", 100, 0, 0, 0)
//ldw_browse.inv_resize.of_register("create_date", 100, 0, 0, 0)
//ldw_browse.inv_resize.of_register("create_date_t", 100, 0, 0, 0)
//ldw_browse.inv_resize.of_register("checkout_by", 100, 0, 0, 0)
//ldw_browse.inv_resize.of_register("checkout_by_t", 100, 0, 0, 0)
//ldw_browse.inv_resize.of_register("checkout_date", 100, 0, 0, 0)
//ldw_browse.inv_resize.of_register("checkout_date_t", 100, 0, 0, 0)
//ldw_browse.inv_resize.of_register("checkout_status", 100, 0, 0, 0)
//ldw_browse.inv_resize.of_register("checkout_status_t", 100, 0, 0, 0)
//ldw_browse.event resize(0, ldw_browse.width, ldw_browse.height)
//
end event
...
if is_filter_company_contact = '1' then
	...
	ldwc_company.filter()
	ldwc_company.setfilter("status = 'A' ")
	ldwc_company.filter()
end if
//end
...
//-----------------------------------------------------------------------------------------------------------
// <RP> 7.9.2016 - check first; when using default DWO, the control ends up with two rows
...
event dw_filter::itemchanged;This.Post event ue_post_itemchanged( row, dwo.name, data)
end event
