...
mle_1.text = 'When using default program to open a document, any change to the document made by the default program will not be saved in Contract Logix system. ~r~nIf you want to make change to a document and then save the change in Contract Logix system, please open it inside Contract Logix or use the Check Out and Check In functions.'
end event
...
string text = "When using default program to pen a document, any change to the document made by the default program will not be saved in ContractLogix system. ~~r~~nIf you want to make change to a document and then save the change in ContractLogix system, please use .."
