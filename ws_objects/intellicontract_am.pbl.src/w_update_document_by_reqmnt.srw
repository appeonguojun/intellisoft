...
For i = 1 To dw_1.RowCount()
	...
	If w_ole_word.ole_1.object.doctype > 0 Then w_ole_word.ole_1.object.ActiveDocument.Saved = True //Added By Ken.Guo 2016-05-23. workaround Task 524
...
//	If gw_contract.tab_contract_details.ib_select9 = True Then
		...
		If gw_contract.tab_contract_details.tabpage_images.tab_1.tabpage_data.il_preview_doc_id > 0 Then
			If gw_contract.tab_contract_details.tabpage_images.tab_1.tabpage_data.tab_1.tabpage_preview.ole_doc.object.doctype > 0 Then 
				gw_contract.tab_contract_details.tabpage_images.tab_1.tabpage_data.tab_1.tabpage_preview.ole_doc.object.ActiveDocument.Saved = True //Added By Ken.Guo 2016-05-23. workaround Task 524
			End If
