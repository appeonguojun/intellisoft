...
type uo_toolbar from uo_dm_image_toolbar within uo_dm_image_view
end type
...
CHOOSE CASE as_menutype
	CASE 'tools'
		...
		//$<reason> Only tif type support OCR function.
		If ole_admin.object.FileType <> 1 Then
			lm_menu.m_image.m_ocr.Visible = False
		End If
		//---------------------------- APPEON END ----------------------------			
	...
	CASE 'page'
		IF ib_readonly THEN
			...
			gnv_app.of_modify_menu_attr(lm_menu.m_pageproperty.m_copypage0,'enabled', false)  //Added By Mark Lee 11/17/2014 add
		END IF
...
//Get version number increment control option
...
Try
	IF is_revision_control = '1' or lb_newVersion THEN
		...
		//End code by Jervis 02.19.2009
			...
			gnv_rights.of_check_dir_right(is_Localfilename, true, 'Image Save')
			//---------------------------- APPEON END ----------------------------
			try
	...
	if (is_revision_control <> '1' and not lb_newVersion) or li_version_increment <> 1 THEN
		//--------------------------- APPEON BEGIN ---------------------------
...

