...
type st_tip from statictext within w_ctx_template_properties
end type
...
integer width = 2505
integer height = 1352
string title = "Contract Template Properties"
st_tip st_tip
dw_1 dw_1
cb_1 cb_1
cb_cancel cb_cancel
...
string text = " You do not have permission to modify it."
