...
integer width = 4453
integer height = 2016
string title = "Contract Requirements Painter"
event ue_new ( )
event ue_retrieve ( )
...
this.Control[iCurrent+3]=this.dw_measurements
this.Control[iCurrent+4]=this.dw_measurement_group
this.Control[iCurrent+5]=this.dw_profile
this.Control[iCurrent+6]=this.cb_delete_measurement
this.Control[iCurrent+7]=this.cb_create_measurement
this.Control[iCurrent+8]=this.cb_delete_group
this.Control[iCurrent+9]=this.cb_create_group
...
event open;call super::open;//Added By Ken.Guo 2016-04-26
If message.doubleparm = 0 Then
