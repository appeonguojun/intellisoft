...
tab_1.tabpage_1.dw_browse.Retrieve( gs_user_id ) //Modified By Jay 2016-07-18
...
If w_mdi.of_security_access( 6956 ) = 0 Then //Save As Template
	cb_delete.enabled = False
End If

//Added By Jay Chen 05-24-2014
If w_mdi.of_security_access( 6955 ) = 1 Then //Use Template
	cb_delete.enabled = False
End If

//Added By Ken.Guo 2015-09-18
inv_contract = Create n_cst_contract
If Not inv_contract.of_allow_newctx() Then 
	cb_ok.enabled = False
End If
end event

event close;call super::close;If isvalid(inv_contract) Then Destroy inv_contract //Added By Ken.Guo 2015-09-18
end event
...
long ll_new_ctx_id,ll_row,ll_template_id, ll_template_ctx_id, ll_cnt, ll_Found
integer li_tab_index
n_cst_copy_ctx lnv_copy_ctx
Dec{0} ldec_Category

//Added By Ken.Guo 2015-09-18. for readonly user.
If Not inv_contract.of_allow_newctx() Then 
...
ll_template_ctx_id = tab_1.tabpage_1.dw_browse.getitemnumber(ll_row,'ctx_id') //Added by gavins 20161130
