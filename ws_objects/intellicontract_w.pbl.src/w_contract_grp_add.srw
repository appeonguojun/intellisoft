...
type st_1 from u_st_splitbar within w_contract_grp_add
end type
type cb_1 from u_cb within w_contract_grp_add
end type
type cb_close from u_cb within w_contract_grp_add
end type
type cb_ok from u_cb within w_contract_grp_add
end type
type dw_master from u_dw within w_contract_grp_add
end type
type dw_detail from u_dw within w_contract_grp_add
end type
type gb_1 from u_gb within w_contract_grp_add
end type
type gb_2 from u_gb within w_contract_grp_add
end type
end forward
...
type dw_detail from u_dw within w_contract_grp_add
string tag = "Associated Group / Location"
integer x = 37
integer y = 880
integer width = 3547
integer height = 784
integer taborder = 10
boolean titlebar = true
string title = "Associated Group / Location"
