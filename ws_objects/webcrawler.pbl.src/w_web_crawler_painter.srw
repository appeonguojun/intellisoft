...
IF tab_main.tabpage_detail.tab_detail.tabpage_steps.dw_steps_detail.RowCount( ) > 0 THEN
	IF IsNull( tab_main.tabpage_detail.tab_detail.tabpage_steps.dw_steps_detail.GetItemNumber( 1, "wc_id" ) )  THEN
		tab_main.tabpage_detail.tab_detail.tabpage_steps.dw_steps_detail.DeleteRow( 1 )
...
//update the wc_multi_entity_link table 
DELETE
...
tab_main.tabpage_detail.tab_detail.tabpage_steps.dw_steps_detail.AcceptText( )
...
res = tab_main.tabpage_detail.tab_detail.tabpage_steps.dw_steps_detail.Update( )
...
event clicked;messagebox("",ii_wc_id)
...
lnvo_web_crawler.of_crawl_new( ii_wc_id,   1, "x-x-x-x", True )
