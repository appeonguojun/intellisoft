...
event open;call super::open;//Added By Jay Chen 06-13-2014
string ls_value,ls_color_checked
long ll_win_ctx_backcolor

ls_value = gnv_data.of_getitem( 'data_view','win_backcolor', 'data_view_id = ' + String(il_SelView) )
...
if tab_1.tabpage_window.dw_3.rowcount() < 1 then return
tab_1.tabpage_window.dw_3.setitem(1, "background_color", ll_win_ctx_backcolor)
tab_1.tabpage_window.dw_3.setitem(1, "background_color_checked", ls_color_checked)
end event
...
choose case dwo.name
	...
	case 'b_fontface_def'
		this.SetItem( row,"font_face","MS Sans Serif")
		this.event itemChanged(row,this.object.font_face,"MS Sans Serif")
...
choose case dwo.name
	...
	Case 'b_fontname_default' //added by gavins 20130415
		This.object.tab_font_name[Row] = "MS Sans Serif"
