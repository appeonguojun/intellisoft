...
//Added by Harry 11-24-2016		
ls_sql += ls_select + "'Custom 1' from ctx_am_document "+&
		"where (contains(Custom_1, '" + is_searchtext + "') Or Exists(select 1 from code_lookup where convert(varchar(75),code_lookup.lookup_code) = ctx_am_document.Custom_1 and contains(code_lookup.code, '" + is_searchtext + "')))" + is_contracts

ls_sql += ls_select + "'Custom 2' from ctx_am_document "+&
		"where (contains(Custom_2, '" + is_searchtext + "') Or Exists(select 1 from code_lookup where convert(varchar(75),code_lookup.lookup_code) = ctx_am_document.Custom_2 and contains(code_lookup.code, '" + is_searchtext + "')))" + is_contracts

ls_sql += ls_select + "'Custom 3' from ctx_am_document "+&
		"where (contains(Custom_3, '" + is_searchtext + "') Or Exists(select 1 from code_lookup where convert(varchar(75),code_lookup.lookup_code) = ctx_am_document.Custom_3 and contains(code_lookup.code, '" + is_searchtext + "')))" + is_contracts

ls_sql += ls_select + "'Custom 4' from ctx_am_document "+&
		"where (contains(Custom_4, '" + is_searchtext + "') Or Exists(select 1 from code_lookup where convert(varchar(75),code_lookup.lookup_code) = ctx_am_document.Custom_4 and contains(code_lookup.code, '" + is_searchtext + "')))" + is_contracts

ls_sql += ls_select + "'Custom 5' from ctx_am_document "+&
		"where (contains(Custom_5, '" + is_searchtext + "') Or Exists(select 1 from code_lookup where convert(varchar(75),code_lookup.lookup_code) = ctx_am_document.Custom_5 and contains(code_lookup.code, '" + is_searchtext + "')))" + is_contracts

ls_sql += ls_select + "'Custom 6' from ctx_am_document "+&
		"where (contains(Custom_6, '" + is_searchtext + "') Or Exists(select 1 from code_lookup where convert(varchar(75),code_lookup.lookup_code) = ctx_am_document.Custom_6 and contains(code_lookup.code, '" + is_searchtext + "')))" + is_contracts

ls_sql += ls_select + "'Custom 7' from ctx_am_document "+&
		"where (contains(Custom_7, '" + is_searchtext + "') Or Exists(select 1 from code_lookup where convert(varchar(75),code_lookup.lookup_code) = ctx_am_document.Custom_7 and contains(code_lookup.code, '" + is_searchtext + "')))" + is_contracts

ls_sql += ls_select + "'Custom 8' from ctx_am_document "+&
		"where (contains(Custom_8, '" + is_searchtext + "') Or Exists(select 1 from code_lookup where convert(varchar(75),code_lookup.lookup_code) = ctx_am_document.Custom_8 and contains(code_lookup.code, '" + is_searchtext + "')))" + is_contracts

ls_sql += ls_select + "'Custom 9' from ctx_am_document "+&
		"where (contains(Custom_9, '" + is_searchtext + "') Or Exists(select 1 from code_lookup where convert(varchar(75),code_lookup.lookup_code) = ctx_am_document.Custom_9 and contains(code_lookup.code, '" + is_searchtext + "')))" + is_contracts

ls_sql += ls_select + "'Custom 10' from ctx_am_document "+&
		"where (contains(Custom_10, '" + is_searchtext + "') Or Exists(select 1 from code_lookup where convert(varchar(75),code_lookup.lookup_code) = ctx_am_document.Custom_10 and contains(code_lookup.code, '" + is_searchtext + "')))" + is_contracts
...
ls_sql += ls_select + "'Custom Notes_1' from ctx_basic_info "+&
...
ls_sql += ls_select + "'Custom Notes_2' from ctx_basic_info "+&
...
ls_sql += ls_select + "'Custom Notes_3' from ctx_basic_info "+&
...
ls_sql += ls_select + "'Custom Notes_4' from ctx_basic_info "+&
...
ls_sql += ls_select + "'Custom Notes_5' from ctx_basic_info "+&
...
ls_sql += ls_select + "'Custom 21' from ctx_basic_info "+&
		"where (contains(custom_21, '" + is_searchtext + "') Or Exists(select 1 from code_lookup where convert(varchar(100),code_lookup.lookup_code) = ctx_basic_info.custom_21 and contains(code_lookup.code, '" + is_searchtext + "')))" + is_contracts
ls_sql += ls_select + "'Custom 22' from ctx_basic_info "+&
		"where (contains(custom_22, '" + is_searchtext + "') Or Exists(select 1 from code_lookup where convert(varchar(100),code_lookup.lookup_code) = ctx_basic_info.custom_22 and contains(code_lookup.code, '" + is_searchtext + "')))" + is_contracts
ls_sql += ls_select + "'Revision Reason' from ctx_basic_info "+&
		"where (contains(revision_reason, '" + is_searchtext + "') Or Exists(select 1 from code_lookup where convert(varchar(100),code_lookup.lookup_code) = ctx_basic_info.revision_reason and contains(code_lookup.code, '" + is_searchtext + "')))" + is_contracts
ls_sql += ls_select + "'Master Contract Name' from ctx_basic_info "+&
		"where (contains(master_contract_name, '" + is_searchtext + "') Or Exists(select 1 from code_lookup where convert(varchar(100),code_lookup.lookup_code) = ctx_basic_info.master_contract_name and contains(code_lookup.code, '" + is_searchtext + "')))" + is_contracts
//end add
...
//Added By Jay Chen 12-05-2013
ls_sql += ls_select + "'Custom Data 2 -> Custom 21' from ctx_custom "+&
		"where (contains(Custom_21, '" + is_searchtext + "') Or Exists(select 1 from code_lookup where convert(varchar(100),code_lookup.lookup_code) = ctx_custom.Custom_21 and contains(code_lookup.code, '" + is_searchtext + "')))" + is_contracts
ls_sql += ls_select + "'Custom Data 2 -> Custom 22' from ctx_custom "+&
		"where (contains(Custom_22, '" + is_searchtext + "') Or Exists(select 1 from code_lookup where convert(varchar(100),code_lookup.lookup_code) = ctx_custom.Custom_22 and contains(code_lookup.code, '" + is_searchtext + "')))" + is_contracts
...
//Added By Harry 11-24-2016
ls_sql += ls_select + "'Custom Data 2 -> Custom 26' from ctx_custom "+&
		"where (contains(Custom_26, '" + is_searchtext + "') Or Exists(select 1 from code_lookup where convert(varchar(100),code_lookup.lookup_code) = ctx_custom.Custom_26 and contains(code_lookup.code, '" + is_searchtext + "')))" + is_contracts
ls_sql += ls_select + "'Custom Data 2 -> Custom 27' from ctx_custom "+&
		"where (contains(Custom_27, '" + is_searchtext + "') Or Exists(select 1 from code_lookup where convert(varchar(100),code_lookup.lookup_code) = ctx_custom.Custom_27 and contains(code_lookup.code, '" + is_searchtext + "')))" + is_contracts
ls_sql += ls_select + "'Custom Data 2 -> Custom 28' from ctx_custom "+&
		"where (contains(Custom_28, '" + is_searchtext + "') Or Exists(select 1 from code_lookup where convert(varchar(100),code_lookup.lookup_code) = ctx_custom.Custom_28 and contains(code_lookup.code, '" + is_searchtext + "')))" + is_contracts
ls_sql += ls_select + "'Custom Data 2 -> Custom 29' from ctx_custom "+&
		"where (contains(Custom_29, '" + is_searchtext + "') Or Exists(select 1 from code_lookup where convert(varchar(100),code_lookup.lookup_code) = ctx_custom.Custom_29 and contains(code_lookup.code, '" + is_searchtext + "')))" + is_contracts
ls_sql += ls_select + "'Custom Data 2 -> Custom 30' from ctx_custom "+&
		"where (contains(Custom_30, '" + is_searchtext + "') Or Exists(select 1 from code_lookup where convert(varchar(100),code_lookup.lookup_code) = ctx_custom.Custom_30 and contains(code_lookup.code, '" + is_searchtext + "')))" + is_contracts
ls_sql += ls_select + "'Custom Data 2 -> Custom 31' from ctx_custom "+&
		"where (contains(Custom_31, '" + is_searchtext + "') Or Exists(select 1 from code_lookup where convert(varchar(100),code_lookup.lookup_code) = ctx_custom.Custom_31 and contains(code_lookup.code, '" + is_searchtext + "')))" + is_contracts
ls_sql += ls_select + "'Custom Data 2 -> Custom 32' from ctx_custom "+&
		"where (contains(Custom_32, '" + is_searchtext + "') Or Exists(select 1 from code_lookup where convert(varchar(100),code_lookup.lookup_code) = ctx_custom.Custom_32 and contains(code_lookup.code, '" + is_searchtext + "')))" + is_contracts
ls_sql += ls_select + "'Custom Data 2 -> Custom 33' from ctx_custom "+&
		"where (contains(Custom_33, '" + is_searchtext + "') Or Exists(select 1 from code_lookup where convert(varchar(100),code_lookup.lookup_code) = ctx_custom.Custom_33 and contains(code_lookup.code, '" + is_searchtext + "')))" + is_contracts
ls_sql += ls_select + "'Custom Data 2 -> Custom 34' from ctx_custom "+&
		"where (contains(Custom_34, '" + is_searchtext + "') Or Exists(select 1 from code_lookup where convert(varchar(100),code_lookup.lookup_code) = ctx_custom.Custom_34 and contains(code_lookup.code, '" + is_searchtext + "')))" + is_contracts
ls_sql += ls_select + "'Custom Data 2 -> Custom 35' from ctx_custom "+&
		"where (contains(Custom_35, '" + is_searchtext + "') Or Exists(select 1 from code_lookup where convert(varchar(100),code_lookup.lookup_code) = ctx_custom.Custom_35 and contains(code_lookup.code, '" + is_searchtext + "')))" + is_contracts
ls_sql += ls_select + "'Custom Data 2 -> Custom 36' from ctx_custom "+&
		"where (contains(Custom_36, '" + is_searchtext + "') Or Exists(select 1 from code_lookup where convert(varchar(100),code_lookup.lookup_code) = ctx_custom.Custom_36 and contains(code_lookup.code, '" + is_searchtext + "')))" + is_contracts
ls_sql += ls_select + "'Custom Data 2 -> Custom 37' from ctx_custom "+&
		"where (contains(Custom_37, '" + is_searchtext + "') Or Exists(select 1 from code_lookup where convert(varchar(100),code_lookup.lookup_code) = ctx_custom.Custom_37 and contains(code_lookup.code, '" + is_searchtext + "')))" + is_contracts
ls_sql += ls_select + "'Custom Data 2 -> Custom 38' from ctx_custom "+&
		"where (contains(Custom_38, '" + is_searchtext + "') Or Exists(select 1 from code_lookup where convert(varchar(100),code_lookup.lookup_code) = ctx_custom.Custom_38 and contains(code_lookup.code, '" + is_searchtext + "')))" + is_contracts
ls_sql += ls_select + "'Custom Data 2 -> Custom 39' from ctx_custom "+&
		"where (contains(Custom_39, '" + is_searchtext + "') Or Exists(select 1 from code_lookup where convert(varchar(100),code_lookup.lookup_code) = ctx_custom.Custom_39 and contains(code_lookup.code, '" + is_searchtext + "')))" + is_contracts
ls_sql += ls_select + "'Custom Data 2 -> Custom 40' from ctx_custom "+&
		"where (contains(Custom_40, '" + is_searchtext + "') Or Exists(select 1 from code_lookup where convert(varchar(100),code_lookup.lookup_code) = ctx_custom.Custom_40 and contains(code_lookup.code, '" + is_searchtext + "')))" + is_contracts
ls_sql += ls_select + "'Custom Data 2 -> Custom 41' from ctx_custom "+&
		"where (contains(Custom_41, '" + is_searchtext + "') Or Exists(select 1 from code_lookup where convert(varchar(100),code_lookup.lookup_code) = ctx_custom.Custom_41 and contains(code_lookup.code, '" + is_searchtext + "')))" + is_contracts
ls_sql += ls_select + "'Custom Data 2 -> Custom 42' from ctx_custom "+&
		"where (contains(Custom_42, '" + is_searchtext + "') Or Exists(select 1 from code_lookup where convert(varchar(100),code_lookup.lookup_code) = ctx_custom.Custom_42 and contains(code_lookup.code, '" + is_searchtext + "')))" + is_contracts
ls_sql += ls_select + "'Custom Data 2 -> Custom 43' from ctx_custom "+&
		"where (contains(Custom_43, '" + is_searchtext + "') Or Exists(select 1 from code_lookup where convert(varchar(100),code_lookup.lookup_code) = ctx_custom.Custom_43 and contains(code_lookup.code, '" + is_searchtext + "')))" + is_contracts
ls_sql += ls_select + "'Custom Data 2 -> Custom 44' from ctx_custom "+&
		"where (contains(Custom_44, '" + is_searchtext + "') Or Exists(select 1 from code_lookup where convert(varchar(100),code_lookup.lookup_code) = ctx_custom.Custom_44 and contains(code_lookup.code, '" + is_searchtext + "')))" + is_contracts
ls_sql += ls_select + "'Custom Data 2 -> Custom 45' from ctx_custom "+&
		"where (contains(Custom_45, '" + is_searchtext + "') Or Exists(select 1 from code_lookup where convert(varchar(100),code_lookup.lookup_code) = ctx_custom.Custom_45 and contains(code_lookup.code, '" + is_searchtext + "')))" + is_contracts
ls_sql += ls_select + "'Custom Data 2 -> Custom 46' from ctx_custom "+&
		"where (contains(Custom_46, '" + is_searchtext + "') Or Exists(select 1 from code_lookup where convert(varchar(100),code_lookup.lookup_code) = ctx_custom.Custom_46 and contains(code_lookup.code, '" + is_searchtext + "')))" + is_contracts
ls_sql += ls_select + "'Custom Data 2 -> Custom 47' from ctx_custom "+&
		"where (contains(Custom_47, '" + is_searchtext + "') Or Exists(select 1 from code_lookup where convert(varchar(100),code_lookup.lookup_code) = ctx_custom.Custom_47 and contains(code_lookup.code, '" + is_searchtext + "')))" + is_contracts
ls_sql += ls_select + "'Custom Data 2 -> Custom 48' from ctx_custom "+&
		"where (contains(Custom_48, '" + is_searchtext + "') Or Exists(select 1 from code_lookup where convert(varchar(100),code_lookup.lookup_code) = ctx_custom.Custom_48 and contains(code_lookup.code, '" + is_searchtext + "')))" + is_contracts
ls_sql += ls_select + "'Custom Data 2 -> Custom 49' from ctx_custom "+&
		"where (contains(Custom_49, '" + is_searchtext + "') Or Exists(select 1 from code_lookup where convert(varchar(100),code_lookup.lookup_code) = ctx_custom.Custom_49 and contains(code_lookup.code, '" + is_searchtext + "')))" + is_contracts
ls_sql += ls_select + "'Custom Data 2 -> Custom 50' from ctx_custom "+&
		"where (contains(Custom_50, '" + is_searchtext + "') Or Exists(select 1 from code_lookup where convert(varchar(100),code_lookup.lookup_code) = ctx_custom.Custom_50 and contains(code_lookup.code, '" + is_searchtext + "')))" + is_contracts
ls_sql += ls_select + "'Custom Data 2 -> Custom 51' from ctx_custom "+&
		"where (contains(Custom_51, '" + is_searchtext + "') Or Exists(select 1 from code_lookup where convert(varchar(100),code_lookup.lookup_code) = ctx_custom.Custom_51 and contains(code_lookup.code, '" + is_searchtext + "')))" + is_contracts
ls_sql += ls_select + "'Custom Data 2 -> Custom 52' from ctx_custom "+&
		"where (contains(Custom_52, '" + is_searchtext + "') Or Exists(select 1 from code_lookup where convert(varchar(100),code_lookup.lookup_code) = ctx_custom.Custom_52 and contains(code_lookup.code, '" + is_searchtext + "')))" + is_contracts
ls_sql += ls_select + "'Custom Data 2 -> Custom 53' from ctx_custom "+&
		"where (contains(Custom_53, '" + is_searchtext + "') Or Exists(select 1 from code_lookup where convert(varchar(100),code_lookup.lookup_code) = ctx_custom.Custom_53 and contains(code_lookup.code, '" + is_searchtext + "')))" + is_contracts
ls_sql += ls_select + "'Custom Data 2 -> Custom 54' from ctx_custom "+&
		"where (contains(Custom_54, '" + is_searchtext + "') Or Exists(select 1 from code_lookup where convert(varchar(100),code_lookup.lookup_code) = ctx_custom.Custom_54 and contains(code_lookup.code, '" + is_searchtext + "')))" + is_contracts
ls_sql += ls_select + "'Custom Data 2 -> Custom 55' from ctx_custom "+&
		"where (contains(Custom_55, '" + is_searchtext + "') Or Exists(select 1 from code_lookup where convert(varchar(100),code_lookup.lookup_code) = ctx_custom.Custom_55 and contains(code_lookup.code, '" + is_searchtext + "')))" + is_contracts
ls_sql += ls_select + "'Custom Data 2 -> Custom 56' from ctx_custom "+&
		"where (contains(Custom_56, '" + is_searchtext + "') Or Exists(select 1 from code_lookup where convert(varchar(100),code_lookup.lookup_code) = ctx_custom.Custom_56 and contains(code_lookup.code, '" + is_searchtext + "')))" + is_contracts
ls_sql += ls_select + "'Custom Data 2 -> Custom 57' from ctx_custom "+&
		"where (contains(Custom_57, '" + is_searchtext + "') Or Exists(select 1 from code_lookup where convert(varchar(100),code_lookup.lookup_code) = ctx_custom.Custom_57 and contains(code_lookup.code, '" + is_searchtext + "')))" + is_contracts
ls_sql += ls_select + "'Custom Data 2 -> Custom 58' from ctx_custom "+&
		"where (contains(Custom_58, '" + is_searchtext + "') Or Exists(select 1 from code_lookup where convert(varchar(100),code_lookup.lookup_code) = ctx_custom.Custom_58 and contains(code_lookup.code, '" + is_searchtext + "')))" + is_contracts
ls_sql += ls_select + "'Custom Data 2 -> Custom 59' from ctx_custom "+&
		"where (contains(Custom_59, '" + is_searchtext + "') Or Exists(select 1 from code_lookup where convert(varchar(100),code_lookup.lookup_code) = ctx_custom.Custom_59 and contains(code_lookup.code, '" + is_searchtext + "')))" + is_contracts
ls_sql += ls_select + "'Custom Data 2 -> Custom 60' from ctx_custom "+&
		"where (contains(Custom_60, '" + is_searchtext + "') Or Exists(select 1 from code_lookup where convert(varchar(100),code_lookup.lookup_code) = ctx_custom.Custom_60 and contains(code_lookup.code, '" + is_searchtext + "')))" + is_contracts
ls_sql += ls_select + "'Custom Data 2 -> Custom 61' from ctx_custom "+&
		"where (contains(Custom_61, '" + is_searchtext + "') Or Exists(select 1 from code_lookup where convert(varchar(100),code_lookup.lookup_code) = ctx_custom.Custom_61 and contains(code_lookup.code, '" + is_searchtext + "')))" + is_contracts
ls_sql += ls_select + "'Custom Data 2 -> Custom 62' from ctx_custom "+&
		"where (contains(Custom_62, '" + is_searchtext + "') Or Exists(select 1 from code_lookup where convert(varchar(100),code_lookup.lookup_code) = ctx_custom.Custom_62 and contains(code_lookup.code, '" + is_searchtext + "')))" + is_contracts
ls_sql += ls_select + "'Custom Data 2 -> Custom 63' from ctx_custom "+&
		"where (contains(Custom_63, '" + is_searchtext + "') Or Exists(select 1 from code_lookup where convert(varchar(100),code_lookup.lookup_code) = ctx_custom.Custom_63 and contains(code_lookup.code, '" + is_searchtext + "')))" + is_contracts
ls_sql += ls_select + "'Custom Data 2 -> Custom 64' from ctx_custom "+&
		"where (contains(Custom_64, '" + is_searchtext + "') Or Exists(select 1 from code_lookup where convert(varchar(100),code_lookup.lookup_code) = ctx_custom.Custom_64 and contains(code_lookup.code, '" + is_searchtext + "')))" + is_contracts
ls_sql += ls_select + "'Custom Data 2 -> Custom 65' from ctx_custom "+&
		"where (contains(Custom_65, '" + is_searchtext + "') Or Exists(select 1 from code_lookup where convert(varchar(100),code_lookup.lookup_code) = ctx_custom.Custom_65 and contains(code_lookup.code, '" + is_searchtext + "')))" + is_contracts
ls_sql += ls_select + "'Custom Data 2 -> Custom 66' from ctx_custom "+&
		"where (contains(Custom_66, '" + is_searchtext + "') Or Exists(select 1 from code_lookup where convert(varchar(100),code_lookup.lookup_code) = ctx_custom.Custom_66 and contains(code_lookup.code, '" + is_searchtext + "')))" + is_contracts
ls_sql += ls_select + "'Custom Data 2 -> Custom 67' from ctx_custom "+&
		"where (contains(Custom_67, '" + is_searchtext + "') Or Exists(select 1 from code_lookup where convert(varchar(100),code_lookup.lookup_code) = ctx_custom.Custom_67 and contains(code_lookup.code, '" + is_searchtext + "')))" + is_contracts
ls_sql += ls_select + "'Custom Data 2 -> Custom 68' from ctx_custom "+&
		"where (contains(Custom_68, '" + is_searchtext + "') Or Exists(select 1 from code_lookup where convert(varchar(100),code_lookup.lookup_code) = ctx_custom.Custom_68 and contains(code_lookup.code, '" + is_searchtext + "')))" + is_contracts
ls_sql += ls_select + "'Custom Data 2 -> Custom 69' from ctx_custom "+&
		"where (contains(Custom_69, '" + is_searchtext + "') Or Exists(select 1 from code_lookup where convert(varchar(100),code_lookup.lookup_code) = ctx_custom.Custom_69 and contains(code_lookup.code, '" + is_searchtext + "')))" + is_contracts
ls_sql += ls_select + "'Custom Data 2 -> Custom 70' from ctx_custom "+&
		"where (contains(Custom_70, '" + is_searchtext + "') Or Exists(select 1 from code_lookup where convert(varchar(100),code_lookup.lookup_code) = ctx_custom.Custom_70 and contains(code_lookup.code, '" + is_searchtext + "')))" + is_contracts
ls_sql += ls_select + "'Custom Data 2 -> Custom 71' from ctx_custom "+&
		"where (contains(Custom_71, '" + is_searchtext + "') Or Exists(select 1 from code_lookup where convert(varchar(100),code_lookup.lookup_code) = ctx_custom.Custom_71 and contains(code_lookup.code, '" + is_searchtext + "')))" + is_contracts
ls_sql += ls_select + "'Custom Data 2 -> Custom 72' from ctx_custom "+&
		"where (contains(Custom_72, '" + is_searchtext + "') Or Exists(select 1 from code_lookup where convert(varchar(100),code_lookup.lookup_code) = ctx_custom.Custom_72 and contains(code_lookup.code, '" + is_searchtext + "')))" + is_contracts
ls_sql += ls_select + "'Custom Data 2 -> Custom 73' from ctx_custom "+&
		"where (contains(Custom_73, '" + is_searchtext + "') Or Exists(select 1 from code_lookup where convert(varchar(100),code_lookup.lookup_code) = ctx_custom.Custom_73 and contains(code_lookup.code, '" + is_searchtext + "')))" + is_contracts
ls_sql += ls_select + "'Custom Data 2 -> Custom 74' from ctx_custom "+&
		"where (contains(Custom_74, '" + is_searchtext + "') Or Exists(select 1 from code_lookup where convert(varchar(100),code_lookup.lookup_code) = ctx_custom.Custom_74 and contains(code_lookup.code, '" + is_searchtext + "')))" + is_contracts
ls_sql += ls_select + "'Custom Data 2 -> Custom 75' from ctx_custom "+&
		"where (contains(Custom_75, '" + is_searchtext + "') Or Exists(select 1 from code_lookup where convert(varchar(100),code_lookup.lookup_code) = ctx_custom.Custom_75 and contains(code_lookup.code, '" + is_searchtext + "')))" + is_contracts
ls_sql += ls_select + "'Custom Data 2 -> Custom Notes_6' from ctx_custom "+&
		"where (contains(custom_notes_6, '" + is_searchtext + "') Or Exists(select 1 from code_lookup where convert(varchar(100),code_lookup.lookup_code) = ctx_custom.custom_notes_6 and contains(code_lookup.code, '" + is_searchtext + "')))" + is_contracts
ls_sql += ls_select + "'Custom Data 2 -> Custom Notes_7' from ctx_custom "+&
		"where (contains(custom_notes_7, '" + is_searchtext + "') Or Exists(select 1 from code_lookup where convert(varchar(100),code_lookup.lookup_code) = ctx_custom.custom_notes_7 and contains(code_lookup.code, '" + is_searchtext + "')))" + is_contracts
ls_sql += ls_select + "'Custom Data 2 -> Custom Notes_8' from ctx_custom "+&
		"where (contains(custom_notes_8, '" + is_searchtext + "') Or Exists(select 1 from code_lookup where convert(varchar(100),code_lookup.lookup_code) = ctx_custom.custom_notes_8 and contains(code_lookup.code, '" + is_searchtext + "')))" + is_contracts
ls_sql += ls_select + "'Custom Data 2 -> Custom Notes_9' from ctx_custom "+&
		"where (contains(custom_notes_9, '" + is_searchtext + "') Or Exists(select 1 from code_lookup where convert(varchar(100),code_lookup.lookup_code) = ctx_custom.custom_notes_9 and contains(code_lookup.code, '" + is_searchtext + "')))" + is_contracts
ls_sql += ls_select + "'Custom Data 2 -> Custom Notes_10' from ctx_custom "+&
		"where (contains(custom_notes_10, '" + is_searchtext + "') Or Exists(select 1 from code_lookup where convert(varchar(100),code_lookup.lookup_code) = ctx_custom.custom_notes_10 and contains(code_lookup.code, '" + is_searchtext + "')))" + is_contracts
...
//Added By Jay Chen 12-05-2013
ls_sql += ls_select + "'Field Value' from ctx_req_profile_hdr "+&
		"where exists(select 1 from ctx_elements where ctx_elements.ctx_req_profile_hdr_id = ctx_req_profile_hdr.ctx_req_profile_hdr_id "+&
		"and contains(field_value, '" + is_searchtext + "'))" + is_contracts
...
//Added by Harry 11-24-2016
ls_sql += ls_select + "'Group / Locations -> Custom 3' from ctx_loc "+&
		"where contains(custom_3, '" + is_searchtext + "')" + is_contracts

ls_sql += ls_select + "'Group / Locations -> Custom 4' from ctx_loc "+&
		"where contains(custom_4, '" + is_searchtext + "')" + is_contracts

ls_sql += ls_select + "'Group / Locations -> Local' from ctx_loc "+&
		"where contains(local, '" + is_searchtext + "')" + is_contracts
...
//Added by Harry 11-24-2016	
ls_sql += ls_select + "'Fee Schedules -> Notes' from ctx_fee_sched_hdr "+&
		"where contains(notes, '" + is_searchtext + "')" + is_contracts

ls_sql += ls_select + "'Fee Schedules -> Custom 3' from ctx_fee_sched_hdr "+&
		"where contains(custom_3, '" + is_searchtext + "')" + is_contracts

ls_sql += ls_select + "'Fee Schedules -> Custom 4' from ctx_fee_sched_hdr "+&
		"where contains(custom_4, '" + is_searchtext + "')" + is_contracts

ls_sql += ls_select + "'Fee Schedules -> Custom 5' from ctx_fee_sched_hdr "+&
...
//Added by Harry 11-24-2016	
ls_sql += ls_select + "'Subject' from ctx_action_items "+&
		"where contains(Subject, '" + is_searchtext + "')" + is_contracts

ls_sql += ls_select + "'Custom 1' from ctx_action_items "+&
		"where (contains(Custom_1, '" + is_searchtext + "') Or Exists(select 1 from code_lookup where convert(varchar(100),code_lookup.lookup_code) = ctx_action_items.Custom_1 and contains(code_lookup.code, '" + is_searchtext + "')))" + is_contracts

ls_sql += ls_select + "'Custom 2' from ctx_action_items "+&
		"where (contains(Custom_2, '" + is_searchtext + "') Or Exists(select 1 from code_lookup where convert(varchar(100),code_lookup.lookup_code) = ctx_action_items.Custom_2 and contains(code_lookup.code, '" + is_searchtext + "')))" + is_contracts

ls_sql += ls_select + "'Custom 3' from ctx_action_items "+&
		"where (contains(Custom_3, '" + is_searchtext + "') Or Exists(select 1 from code_lookup where convert(varchar(100),code_lookup.lookup_code) = ctx_action_items.Custom_3 and contains(code_lookup.code, '" + is_searchtext + "')))" + is_contracts

ls_sql += ls_select + "'Custom 4' from ctx_action_items "+&
		"where (contains(Custom_4, '" + is_searchtext + "') Or Exists(select 1 from code_lookup where convert(varchar(100),code_lookup.lookup_code) = ctx_action_items.Custom_4 and contains(code_lookup.code, '" + is_searchtext + "')))" + is_contracts
...
//Added by Harry 11-24-2016	
ls_sql += ls_select + "'Notes' from ctx_fee_sched_nm "+&
		"where contains(notes, '" + is_searchtext + "')" + is_contracts
...
//Added By Jay Chen 11-27-2013
ls_sql += ls_select + "'Header ('+convert(varchar(100),ctx_custom_multi_hdr.hdr_id)+') -> Custom 11' from ctx_custom_multi_hdr "+&
		"where exists(select 1 from code_lookup where ctx_custom_multi_hdr.custom_11 = convert(varchar(100),code_lookup.lookup_code) and contains(code_lookup.code, '" + is_searchtext + "') or contains(ctx_custom_multi_hdr.custom_11, '"+is_searchtext+"') )" + is_contracts
ls_sql += ls_select + "'Header ('+convert(varchar(100),ctx_custom_multi_hdr.hdr_id)+') -> Custom 12' from ctx_custom_multi_hdr "+&
		"where exists(select 1 from code_lookup where ctx_custom_multi_hdr.custom_12 = convert(varchar(100),code_lookup.lookup_code) and contains(code_lookup.code, '" + is_searchtext + "') or contains(ctx_custom_multi_hdr.custom_12, '"+is_searchtext+"') )" + is_contracts
ls_sql += ls_select + "'Header ('+convert(varchar(100),ctx_custom_multi_hdr.hdr_id)+') -> Custom 13' from ctx_custom_multi_hdr "+&
		"where exists(select 1 from code_lookup where ctx_custom_multi_hdr.custom_13 = convert(varchar(100),code_lookup.lookup_code) and contains(code_lookup.code, '" + is_searchtext + "') or contains(ctx_custom_multi_hdr.custom_13, '"+is_searchtext+"') )" + is_contracts
ls_sql += ls_select + "'Header ('+convert(varchar(100),ctx_custom_multi_hdr.hdr_id)+') -> Custom 14' from ctx_custom_multi_hdr "+&
		"where exists(select 1 from code_lookup where ctx_custom_multi_hdr.custom_14 = convert(varchar(100),code_lookup.lookup_code) and contains(code_lookup.code, '" + is_searchtext + "') or contains(ctx_custom_multi_hdr.custom_14, '"+is_searchtext+"') )" + is_contracts
ls_sql += ls_select + "'Header ('+convert(varchar(100),ctx_custom_multi_hdr.hdr_id)+') -> Custom 15' from ctx_custom_multi_hdr "+&
		"where exists(select 1 from code_lookup where ctx_custom_multi_hdr.custom_15 = convert(varchar(100),code_lookup.lookup_code) and contains(code_lookup.code, '" + is_searchtext + "') or contains(ctx_custom_multi_hdr.custom_15, '"+is_searchtext+"') )" + is_contracts
ls_sql += ls_select + "'Header ('+convert(varchar(100),ctx_custom_multi_hdr.hdr_id)+') -> Custom 16' from ctx_custom_multi_hdr "+&
		"where exists(select 1 from code_lookup where ctx_custom_multi_hdr.custom_16 = convert(varchar(100),code_lookup.lookup_code) and contains(code_lookup.code, '" + is_searchtext + "') or contains(ctx_custom_multi_hdr.custom_16, '"+is_searchtext+"') )" + is_contracts
ls_sql += ls_select + "'Header ('+convert(varchar(100),ctx_custom_multi_hdr.hdr_id)+') -> Custom 17' from ctx_custom_multi_hdr "+&
		"where exists(select 1 from code_lookup where ctx_custom_multi_hdr.custom_17 = convert(varchar(100),code_lookup.lookup_code) and contains(code_lookup.code, '" + is_searchtext + "') or contains(ctx_custom_multi_hdr.custom_17, '"+is_searchtext+"') )" + is_contracts
ls_sql += ls_select + "'Header ('+convert(varchar(100),ctx_custom_multi_hdr.hdr_id)+') -> Custom 18' from ctx_custom_multi_hdr "+&
		"where exists(select 1 from code_lookup where ctx_custom_multi_hdr.custom_18 = convert(varchar(100),code_lookup.lookup_code) and contains(code_lookup.code, '" + is_searchtext + "') or contains(ctx_custom_multi_hdr.custom_18, '"+is_searchtext+"') )" + is_contracts
ls_sql += ls_select + "'Header ('+convert(varchar(100),ctx_custom_multi_hdr.hdr_id)+') -> Custom 19' from ctx_custom_multi_hdr "+&
		"where exists(select 1 from code_lookup where ctx_custom_multi_hdr.custom_19 = convert(varchar(100),code_lookup.lookup_code) and contains(code_lookup.code, '" + is_searchtext + "') or contains(ctx_custom_multi_hdr.custom_19, '"+is_searchtext+"') )" + is_contracts
ls_sql += ls_select + "'Header ('+convert(varchar(100),ctx_custom_multi_hdr.hdr_id)+') -> Custom 20' from ctx_custom_multi_hdr "+&
		"where exists(select 1 from code_lookup where ctx_custom_multi_hdr.custom_20 = convert(varchar(100),code_lookup.lookup_code) and contains(code_lookup.code, '" + is_searchtext + "') or contains(ctx_custom_multi_hdr.custom_20, '"+is_searchtext+"') )" + is_contracts
ls_sql += ls_select + "'Header ('+convert(varchar(100),ctx_custom_multi_hdr.hdr_id)+') -> Custom 21' from ctx_custom_multi_hdr "+&
		"where exists(select 1 from code_lookup where ctx_custom_multi_hdr.custom_21 = convert(varchar(100),code_lookup.lookup_code) and contains(code_lookup.code, '" + is_searchtext + "') or contains(ctx_custom_multi_hdr.custom_21, '"+is_searchtext+"') )" + is_contracts
ls_sql += ls_select + "'Header ('+convert(varchar(100),ctx_custom_multi_hdr.hdr_id)+') -> Custom 22' from ctx_custom_multi_hdr "+&
		"where exists(select 1 from code_lookup where ctx_custom_multi_hdr.custom_22 = convert(varchar(100),code_lookup.lookup_code) and contains(code_lookup.code, '" + is_searchtext + "') or contains(ctx_custom_multi_hdr.custom_22, '"+is_searchtext+"') )" + is_contracts
ls_sql += ls_select + "'Header ('+convert(varchar(100),ctx_custom_multi_hdr.hdr_id)+') -> Custom 23' from ctx_custom_multi_hdr "+&
		"where exists(select 1 from code_lookup where ctx_custom_multi_hdr.custom_23 = convert(varchar(100),code_lookup.lookup_code) and contains(code_lookup.code, '" + is_searchtext + "') or contains(ctx_custom_multi_hdr.custom_23, '"+is_searchtext+"') )" + is_contracts
ls_sql += ls_select + "'Header ('+convert(varchar(100),ctx_custom_multi_hdr.hdr_id)+') -> Custom 24' from ctx_custom_multi_hdr "+&
		"where exists(select 1 from code_lookup where ctx_custom_multi_hdr.custom_24 = convert(varchar(100),code_lookup.lookup_code) and contains(code_lookup.code, '" + is_searchtext + "') or contains(ctx_custom_multi_hdr.custom_24, '"+is_searchtext+"') )" + is_contracts
ls_sql += ls_select + "'Header ('+convert(varchar(100),ctx_custom_multi_hdr.hdr_id)+') -> Custom 25' from ctx_custom_multi_hdr "+&
		"where exists(select 1 from code_lookup where ctx_custom_multi_hdr.custom_25 = convert(varchar(100),code_lookup.lookup_code) and contains(code_lookup.code, '" + is_searchtext + "') or contains(ctx_custom_multi_hdr.custom_25, '"+is_searchtext+"') )" + is_contracts
ls_sql += ls_select + "'Header ('+convert(varchar(100),ctx_custom_multi_hdr.hdr_id)+') -> Custom 26' from ctx_custom_multi_hdr "+&
		"where exists(select 1 from code_lookup where ctx_custom_multi_hdr.custom_26 = convert(varchar(100),code_lookup.lookup_code) and contains(code_lookup.code, '" + is_searchtext + "') or contains(ctx_custom_multi_hdr.custom_26, '"+is_searchtext+"') )" + is_contracts
ls_sql += ls_select + "'Header ('+convert(varchar(100),ctx_custom_multi_hdr.hdr_id)+') -> Custom 27' from ctx_custom_multi_hdr "+&
		"where exists(select 1 from code_lookup where ctx_custom_multi_hdr.custom_27 = convert(varchar(100),code_lookup.lookup_code) and contains(code_lookup.code, '" + is_searchtext + "') or contains(ctx_custom_multi_hdr.custom_27, '"+is_searchtext+"') )" + is_contracts
ls_sql += ls_select + "'Header ('+convert(varchar(100),ctx_custom_multi_hdr.hdr_id)+') -> Custom 28' from ctx_custom_multi_hdr "+&
		"where exists(select 1 from code_lookup where ctx_custom_multi_hdr.custom_28 = convert(varchar(100),code_lookup.lookup_code) and contains(code_lookup.code, '" + is_searchtext + "') or contains(ctx_custom_multi_hdr.custom_28, '"+is_searchtext+"') )" + is_contracts
ls_sql += ls_select + "'Header ('+convert(varchar(100),ctx_custom_multi_hdr.hdr_id)+') -> Custom 29' from ctx_custom_multi_hdr "+&
		"where exists(select 1 from code_lookup where ctx_custom_multi_hdr.custom_29 = convert(varchar(100),code_lookup.lookup_code) and contains(code_lookup.code, '" + is_searchtext + "') or contains(ctx_custom_multi_hdr.custom_29, '"+is_searchtext+"') )" + is_contracts
ls_sql += ls_select + "'Header ('+convert(varchar(100),ctx_custom_multi_hdr.hdr_id)+') -> Custom 30' from ctx_custom_multi_hdr "+&
		"where exists(select 1 from code_lookup where ctx_custom_multi_hdr.custom_30 = convert(varchar(100),code_lookup.lookup_code) and contains(code_lookup.code, '" + is_searchtext + "') or contains(ctx_custom_multi_hdr.custom_30, '"+is_searchtext+"') )" + is_contracts
ls_sql += ls_select + "'Header ('+convert(varchar(100),ctx_custom_multi_hdr.hdr_id)+') -> Custom 31' from ctx_custom_multi_hdr "+&
		"where exists(select 1 from code_lookup where ctx_custom_multi_hdr.custom_31 = convert(varchar(100),code_lookup.lookup_code) and contains(code_lookup.code, '" + is_searchtext + "') or contains(ctx_custom_multi_hdr.custom_31, '"+is_searchtext+"') )" + is_contracts
ls_sql += ls_select + "'Header ('+convert(varchar(100),ctx_custom_multi_hdr.hdr_id)+') -> Custom 32' from ctx_custom_multi_hdr "+&
		"where exists(select 1 from code_lookup where ctx_custom_multi_hdr.custom_32 = convert(varchar(100),code_lookup.lookup_code) and contains(code_lookup.code, '" + is_searchtext + "') or contains(ctx_custom_multi_hdr.custom_32, '"+is_searchtext+"') )" + is_contracts
ls_sql += ls_select + "'Header ('+convert(varchar(100),ctx_custom_multi_hdr.hdr_id)+') -> Custom 33' from ctx_custom_multi_hdr "+&
		"where exists(select 1 from code_lookup where ctx_custom_multi_hdr.custom_33 = convert(varchar(100),code_lookup.lookup_code) and contains(code_lookup.code, '" + is_searchtext + "') or contains(ctx_custom_multi_hdr.custom_33, '"+is_searchtext+"') )" + is_contracts
ls_sql += ls_select + "'Header ('+convert(varchar(100),ctx_custom_multi_hdr.hdr_id)+') -> Custom 34' from ctx_custom_multi_hdr "+&
		"where exists(select 1 from code_lookup where ctx_custom_multi_hdr.custom_34 = convert(varchar(100),code_lookup.lookup_code) and contains(code_lookup.code, '" + is_searchtext + "') or contains(ctx_custom_multi_hdr.custom_34, '"+is_searchtext+"') )" + is_contracts
ls_sql += ls_select + "'Header ('+convert(varchar(100),ctx_custom_multi_hdr.hdr_id)+') -> Custom 35' from ctx_custom_multi_hdr "+&
		"where exists(select 1 from code_lookup where ctx_custom_multi_hdr.custom_35 = convert(varchar(100),code_lookup.lookup_code) and contains(code_lookup.code, '" + is_searchtext + "') or contains(ctx_custom_multi_hdr.custom_35, '"+is_searchtext+"') )" + is_contracts
ls_sql += ls_select + "'Header ('+convert(varchar(100),ctx_custom_multi_hdr.hdr_id)+') -> Custom 36' from ctx_custom_multi_hdr "+&
		"where exists(select 1 from code_lookup where ctx_custom_multi_hdr.custom_36 = convert(varchar(100),code_lookup.lookup_code) and contains(code_lookup.code, '" + is_searchtext + "') or contains(ctx_custom_multi_hdr.custom_36, '"+is_searchtext+"') )" + is_contracts
ls_sql += ls_select + "'Header ('+convert(varchar(100),ctx_custom_multi_hdr.hdr_id)+') -> Custom 37' from ctx_custom_multi_hdr "+&
		"where exists(select 1 from code_lookup where ctx_custom_multi_hdr.custom_37 = convert(varchar(100),code_lookup.lookup_code) and contains(code_lookup.code, '" + is_searchtext + "') or contains(ctx_custom_multi_hdr.custom_37, '"+is_searchtext+"') )" + is_contracts
ls_sql += ls_select + "'Header ('+convert(varchar(100),ctx_custom_multi_hdr.hdr_id)+') -> Custom 38' from ctx_custom_multi_hdr "+&
		"where exists(select 1 from code_lookup where ctx_custom_multi_hdr.custom_38 = convert(varchar(100),code_lookup.lookup_code) and contains(code_lookup.code, '" + is_searchtext + "') or contains(ctx_custom_multi_hdr.custom_38, '"+is_searchtext+"') )" + is_contracts
ls_sql += ls_select + "'Header ('+convert(varchar(100),ctx_custom_multi_hdr.hdr_id)+') -> Custom 39' from ctx_custom_multi_hdr "+&
		"where exists(select 1 from code_lookup where ctx_custom_multi_hdr.custom_39 = convert(varchar(100),code_lookup.lookup_code) and contains(code_lookup.code, '" + is_searchtext + "') or contains(ctx_custom_multi_hdr.custom_39, '"+is_searchtext+"') )" + is_contracts
ls_sql += ls_select + "'Header ('+convert(varchar(100),ctx_custom_multi_hdr.hdr_id)+') -> Custom 40' from ctx_custom_multi_hdr "+&
		"where exists(select 1 from code_lookup where ctx_custom_multi_hdr.custom_40 = convert(varchar(100),code_lookup.lookup_code) and contains(code_lookup.code, '" + is_searchtext + "') or contains(ctx_custom_multi_hdr.custom_40, '"+is_searchtext+"') )" + is_contracts
ls_sql += ls_select + "'Header ('+convert(varchar(100),ctx_custom_multi_hdr.hdr_id)+') -> Custom 41' from ctx_custom_multi_hdr "+&
		"where exists(select 1 from code_lookup where ctx_custom_multi_hdr.custom_41 = convert(varchar(100),code_lookup.lookup_code) and contains(code_lookup.code, '" + is_searchtext + "') or contains(ctx_custom_multi_hdr.custom_41, '"+is_searchtext+"') )" + is_contracts
ls_sql += ls_select + "'Header ('+convert(varchar(100),ctx_custom_multi_hdr.hdr_id)+') -> Custom 42' from ctx_custom_multi_hdr "+&
		"where exists(select 1 from code_lookup where ctx_custom_multi_hdr.custom_42 = convert(varchar(100),code_lookup.lookup_code) and contains(code_lookup.code, '" + is_searchtext + "') or contains(ctx_custom_multi_hdr.custom_42, '"+is_searchtext+"') )" + is_contracts
ls_sql += ls_select + "'Header ('+convert(varchar(100),ctx_custom_multi_hdr.hdr_id)+') -> Custom 43' from ctx_custom_multi_hdr "+&
		"where exists(select 1 from code_lookup where ctx_custom_multi_hdr.custom_43 = convert(varchar(100),code_lookup.lookup_code) and contains(code_lookup.code, '" + is_searchtext + "') or contains(ctx_custom_multi_hdr.custom_43, '"+is_searchtext+"') )" + is_contracts
ls_sql += ls_select + "'Header ('+convert(varchar(100),ctx_custom_multi_hdr.hdr_id)+') -> Custom 44' from ctx_custom_multi_hdr "+&
		"where exists(select 1 from code_lookup where ctx_custom_multi_hdr.custom_44 = convert(varchar(100),code_lookup.lookup_code) and contains(code_lookup.code, '" + is_searchtext + "') or contains(ctx_custom_multi_hdr.custom_44, '"+is_searchtext+"') )" + is_contracts
ls_sql += ls_select + "'Header ('+convert(varchar(100),ctx_custom_multi_hdr.hdr_id)+') -> Custom 45' from ctx_custom_multi_hdr "+&
		"where exists(select 1 from code_lookup where ctx_custom_multi_hdr.custom_45 = convert(varchar(100),code_lookup.lookup_code) and contains(code_lookup.code, '" + is_searchtext + "') or contains(ctx_custom_multi_hdr.custom_45, '"+is_searchtext+"') )" + is_contracts
ls_sql += ls_select + "'Header ('+convert(varchar(100),ctx_custom_multi_hdr.hdr_id)+') -> Custom 46' from ctx_custom_multi_hdr "+&
		"where exists(select 1 from code_lookup where ctx_custom_multi_hdr.custom_46 = convert(varchar(100),code_lookup.lookup_code) and contains(code_lookup.code, '" + is_searchtext + "') or contains(ctx_custom_multi_hdr.custom_46, '"+is_searchtext+"') )" + is_contracts
ls_sql += ls_select + "'Header ('+convert(varchar(100),ctx_custom_multi_hdr.hdr_id)+') -> Custom 47' from ctx_custom_multi_hdr "+&
		"where exists(select 1 from code_lookup where ctx_custom_multi_hdr.custom_47 = convert(varchar(100),code_lookup.lookup_code) and contains(code_lookup.code, '" + is_searchtext + "') or contains(ctx_custom_multi_hdr.custom_47, '"+is_searchtext+"') )" + is_contracts
ls_sql += ls_select + "'Header ('+convert(varchar(100),ctx_custom_multi_hdr.hdr_id)+') -> Custom 48' from ctx_custom_multi_hdr "+&
		"where exists(select 1 from code_lookup where ctx_custom_multi_hdr.custom_48 = convert(varchar(100),code_lookup.lookup_code) and contains(code_lookup.code, '" + is_searchtext + "') or contains(ctx_custom_multi_hdr.custom_48, '"+is_searchtext+"') )" + is_contracts
ls_sql += ls_select + "'Header ('+convert(varchar(100),ctx_custom_multi_hdr.hdr_id)+') -> Custom 49' from ctx_custom_multi_hdr "+&
		"where exists(select 1 from code_lookup where ctx_custom_multi_hdr.custom_49 = convert(varchar(100),code_lookup.lookup_code) and contains(code_lookup.code, '" + is_searchtext + "') or contains(ctx_custom_multi_hdr.custom_49, '"+is_searchtext+"') )" + is_contracts
ls_sql += ls_select + "'Header ('+convert(varchar(100),ctx_custom_multi_hdr.hdr_id)+') -> Custom 50' from ctx_custom_multi_hdr "+&
		"where exists(select 1 from code_lookup where ctx_custom_multi_hdr.custom_50 = convert(varchar(100),code_lookup.lookup_code) and contains(code_lookup.code, '" + is_searchtext + "') or contains(ctx_custom_multi_hdr.custom_50, '"+is_searchtext+"') )" + is_contracts
...
//Added By Jay Chen 11-27-2013
ls_sql += ls_select + "'Detail ('+ convert(varchar(100),ctx_custom_multi_detail.hdr_id) +','+convert(varchar(100),ctx_custom_multi_detail.detail_id) +') -> Custom 11' from ctx_custom_multi_detail "+&
		"where exists(select 1 from code_lookup where ctx_custom_multi_detail.custom_11 = convert(varchar(100),code_lookup.lookup_code) and contains(code_lookup.code, '" + is_searchtext + "') or contains(ctx_custom_multi_detail.custom_11, '"+is_searchtext+"') )" + is_contracts
ls_sql += ls_select + "'Detail ('+ convert(varchar(100),ctx_custom_multi_detail.hdr_id) +','+convert(varchar(100),ctx_custom_multi_detail.detail_id) +') -> Custom 12' from ctx_custom_multi_detail "+&
		"where exists(select 1 from code_lookup where ctx_custom_multi_detail.custom_12 = convert(varchar(100),code_lookup.lookup_code) and contains(code_lookup.code, '" + is_searchtext + "') or contains(ctx_custom_multi_detail.custom_12, '"+is_searchtext+"') )" + is_contracts
ls_sql += ls_select + "'Detail ('+ convert(varchar(100),ctx_custom_multi_detail.hdr_id) +','+convert(varchar(100),ctx_custom_multi_detail.detail_id) +') -> Custom 13' from ctx_custom_multi_detail "+&
		"where exists(select 1 from code_lookup where ctx_custom_multi_detail.custom_13 = convert(varchar(100),code_lookup.lookup_code) and contains(code_lookup.code, '" + is_searchtext + "') or contains(ctx_custom_multi_detail.custom_13, '"+is_searchtext+"') )" + is_contracts
ls_sql += ls_select + "'Detail ('+ convert(varchar(100),ctx_custom_multi_detail.hdr_id) +','+convert(varchar(100),ctx_custom_multi_detail.detail_id) +') -> Custom 14' from ctx_custom_multi_detail "+&
		"where exists(select 1 from code_lookup where ctx_custom_multi_detail.custom_14 = convert(varchar(100),code_lookup.lookup_code) and contains(code_lookup.code, '" + is_searchtext + "') or contains(ctx_custom_multi_detail.custom_14, '"+is_searchtext+"') )" + is_contracts
ls_sql += ls_select + "'Detail ('+ convert(varchar(100),ctx_custom_multi_detail.hdr_id) +','+convert(varchar(100),ctx_custom_multi_detail.detail_id) +') -> Custom 15' from ctx_custom_multi_detail "+&
		"where exists(select 1 from code_lookup where ctx_custom_multi_detail.custom_15 = convert(varchar(100),code_lookup.lookup_code) and contains(code_lookup.code, '" + is_searchtext + "') or contains(ctx_custom_multi_detail.custom_15, '"+is_searchtext+"') )" + is_contracts
ls_sql += ls_select + "'Detail ('+ convert(varchar(100),ctx_custom_multi_detail.hdr_id) +','+convert(varchar(100),ctx_custom_multi_detail.detail_id) +') -> Custom 16' from ctx_custom_multi_detail "+&
		"where exists(select 1 from code_lookup where ctx_custom_multi_detail.custom_16 = convert(varchar(100),code_lookup.lookup_code) and contains(code_lookup.code, '" + is_searchtext + "') or contains(ctx_custom_multi_detail.custom_16, '"+is_searchtext+"') )" + is_contracts
ls_sql += ls_select + "'Detail ('+ convert(varchar(100),ctx_custom_multi_detail.hdr_id) +','+convert(varchar(100),ctx_custom_multi_detail.detail_id) +') -> Custom 17' from ctx_custom_multi_detail "+&
		"where exists(select 1 from code_lookup where ctx_custom_multi_detail.custom_17 = convert(varchar(100),code_lookup.lookup_code) and contains(code_lookup.code, '" + is_searchtext + "') or contains(ctx_custom_multi_detail.custom_17, '"+is_searchtext+"') )" + is_contracts
ls_sql += ls_select + "'Detail ('+ convert(varchar(100),ctx_custom_multi_detail.hdr_id) +','+convert(varchar(100),ctx_custom_multi_detail.detail_id) +') -> Custom 18' from ctx_custom_multi_detail "+&
		"where exists(select 1 from code_lookup where ctx_custom_multi_detail.custom_18 = convert(varchar(100),code_lookup.lookup_code) and contains(code_lookup.code, '" + is_searchtext + "') or contains(ctx_custom_multi_detail.custom_18, '"+is_searchtext+"') )" + is_contracts
ls_sql += ls_select + "'Detail ('+ convert(varchar(100),ctx_custom_multi_detail.hdr_id) +','+convert(varchar(100),ctx_custom_multi_detail.detail_id) +') -> Custom 19' from ctx_custom_multi_detail "+&
		"where exists(select 1 from code_lookup where ctx_custom_multi_detail.custom_19 = convert(varchar(100),code_lookup.lookup_code) and contains(code_lookup.code, '" + is_searchtext + "') or contains(ctx_custom_multi_detail.custom_19, '"+is_searchtext+"') )" + is_contracts
ls_sql += ls_select + "'Detail ('+ convert(varchar(100),ctx_custom_multi_detail.hdr_id) +','+convert(varchar(100),ctx_custom_multi_detail.detail_id) +') -> Custom 20' from ctx_custom_multi_detail "+&
		"where exists(select 1 from code_lookup where ctx_custom_multi_detail.custom_20 = convert(varchar(100),code_lookup.lookup_code) and contains(code_lookup.code, '" + is_searchtext + "') or contains(ctx_custom_multi_detail.custom_20, '"+is_searchtext+"') )" + is_contracts
ls_sql += ls_select + "'Detail ('+ convert(varchar(100),ctx_custom_multi_detail.hdr_id) +','+convert(varchar(100),ctx_custom_multi_detail.detail_id) +') -> Custom 21' from ctx_custom_multi_detail "+&
		"where exists(select 1 from code_lookup where ctx_custom_multi_detail.custom_21 = convert(varchar(100),code_lookup.lookup_code) and contains(code_lookup.code, '" + is_searchtext + "') or contains(ctx_custom_multi_detail.custom_21, '"+is_searchtext+"') )" + is_contracts
ls_sql += ls_select + "'Detail ('+ convert(varchar(100),ctx_custom_multi_detail.hdr_id) +','+convert(varchar(100),ctx_custom_multi_detail.detail_id) +') -> Custom 22' from ctx_custom_multi_detail "+&
		"where exists(select 1 from code_lookup where ctx_custom_multi_detail.custom_22 = convert(varchar(100),code_lookup.lookup_code) and contains(code_lookup.code, '" + is_searchtext + "') or contains(ctx_custom_multi_detail.custom_22, '"+is_searchtext+"') )" + is_contracts
ls_sql += ls_select + "'Detail ('+ convert(varchar(100),ctx_custom_multi_detail.hdr_id) +','+convert(varchar(100),ctx_custom_multi_detail.detail_id) +') -> Custom 23' from ctx_custom_multi_detail "+&
		"where exists(select 1 from code_lookup where ctx_custom_multi_detail.custom_23 = convert(varchar(100),code_lookup.lookup_code) and contains(code_lookup.code, '" + is_searchtext + "') or contains(ctx_custom_multi_detail.custom_23, '"+is_searchtext+"') )" + is_contracts
ls_sql += ls_select + "'Detail ('+ convert(varchar(100),ctx_custom_multi_detail.hdr_id) +','+convert(varchar(100),ctx_custom_multi_detail.detail_id) +') -> Custom 24' from ctx_custom_multi_detail "+&
		"where exists(select 1 from code_lookup where ctx_custom_multi_detail.custom_24 = convert(varchar(100),code_lookup.lookup_code) and contains(code_lookup.code, '" + is_searchtext + "') or contains(ctx_custom_multi_detail.custom_24, '"+is_searchtext+"') )" + is_contracts
ls_sql += ls_select + "'Detail ('+ convert(varchar(100),ctx_custom_multi_detail.hdr_id) +','+convert(varchar(100),ctx_custom_multi_detail.detail_id) +') -> Custom 25' from ctx_custom_multi_detail "+&
		"where exists(select 1 from code_lookup where ctx_custom_multi_detail.custom_25 = convert(varchar(100),code_lookup.lookup_code) and contains(code_lookup.code, '" + is_searchtext + "') or contains(ctx_custom_multi_detail.custom_25, '"+is_searchtext+"') )" + is_contracts
ls_sql += ls_select + "'Detail ('+ convert(varchar(100),ctx_custom_multi_detail.hdr_id) +','+convert(varchar(100),ctx_custom_multi_detail.detail_id) +') -> Custom 26' from ctx_custom_multi_detail "+&
		"where exists(select 1 from code_lookup where ctx_custom_multi_detail.custom_26 = convert(varchar(100),code_lookup.lookup_code) and contains(code_lookup.code, '" + is_searchtext + "') or contains(ctx_custom_multi_detail.custom_26, '"+is_searchtext+"') )" + is_contracts
ls_sql += ls_select + "'Detail ('+ convert(varchar(100),ctx_custom_multi_detail.hdr_id) +','+convert(varchar(100),ctx_custom_multi_detail.detail_id) +') -> Custom 27' from ctx_custom_multi_detail "+&
		"where exists(select 1 from code_lookup where ctx_custom_multi_detail.custom_27 = convert(varchar(100),code_lookup.lookup_code) and contains(code_lookup.code, '" + is_searchtext + "') or contains(ctx_custom_multi_detail.custom_27, '"+is_searchtext+"') )" + is_contracts
ls_sql += ls_select + "'Detail ('+ convert(varchar(100),ctx_custom_multi_detail.hdr_id) +','+convert(varchar(100),ctx_custom_multi_detail.detail_id) +') -> Custom 28' from ctx_custom_multi_detail "+&
		"where exists(select 1 from code_lookup where ctx_custom_multi_detail.custom_28 = convert(varchar(100),code_lookup.lookup_code) and contains(code_lookup.code, '" + is_searchtext + "') or contains(ctx_custom_multi_detail.custom_28, '"+is_searchtext+"') )" + is_contracts
ls_sql += ls_select + "'Detail ('+ convert(varchar(100),ctx_custom_multi_detail.hdr_id) +','+convert(varchar(100),ctx_custom_multi_detail.detail_id) +') -> Custom 29' from ctx_custom_multi_detail "+&
		"where exists(select 1 from code_lookup where ctx_custom_multi_detail.custom_29 = convert(varchar(100),code_lookup.lookup_code) and contains(code_lookup.code, '" + is_searchtext + "') or contains(ctx_custom_multi_detail.custom_29, '"+is_searchtext+"') )" + is_contracts
ls_sql += ls_select + "'Detail ('+ convert(varchar(100),ctx_custom_multi_detail.hdr_id) +','+convert(varchar(100),ctx_custom_multi_detail.detail_id) +') -> Custom 30' from ctx_custom_multi_detail "+&
		"where exists(select 1 from code_lookup where ctx_custom_multi_detail.custom_30 = convert(varchar(100),code_lookup.lookup_code) and contains(code_lookup.code, '" + is_searchtext + "') or contains(ctx_custom_multi_detail.custom_30, '"+is_searchtext+"') )" + is_contracts
ls_sql += ls_select + "'Detail ('+ convert(varchar(100),ctx_custom_multi_detail.hdr_id) +','+convert(varchar(100),ctx_custom_multi_detail.detail_id) +') -> Custom 31' from ctx_custom_multi_detail "+&
		"where exists(select 1 from code_lookup where ctx_custom_multi_detail.custom_31 = convert(varchar(100),code_lookup.lookup_code) and contains(code_lookup.code, '" + is_searchtext + "') or contains(ctx_custom_multi_detail.custom_31, '"+is_searchtext+"') )" + is_contracts
ls_sql += ls_select + "'Detail ('+ convert(varchar(100),ctx_custom_multi_detail.hdr_id) +','+convert(varchar(100),ctx_custom_multi_detail.detail_id) +') -> Custom 32' from ctx_custom_multi_detail "+&
		"where exists(select 1 from code_lookup where ctx_custom_multi_detail.custom_32 = convert(varchar(100),code_lookup.lookup_code) and contains(code_lookup.code, '" + is_searchtext + "') or contains(ctx_custom_multi_detail.custom_32, '"+is_searchtext+"') )" + is_contracts
ls_sql += ls_select + "'Detail ('+ convert(varchar(100),ctx_custom_multi_detail.hdr_id) +','+convert(varchar(100),ctx_custom_multi_detail.detail_id) +') -> Custom 33' from ctx_custom_multi_detail "+&
		"where exists(select 1 from code_lookup where ctx_custom_multi_detail.custom_33 = convert(varchar(100),code_lookup.lookup_code) and contains(code_lookup.code, '" + is_searchtext + "') or contains(ctx_custom_multi_detail.custom_33, '"+is_searchtext+"') )" + is_contracts
ls_sql += ls_select + "'Detail ('+ convert(varchar(100),ctx_custom_multi_detail.hdr_id) +','+convert(varchar(100),ctx_custom_multi_detail.detail_id) +') -> Custom 34' from ctx_custom_multi_detail "+&
		"where exists(select 1 from code_lookup where ctx_custom_multi_detail.custom_34 = convert(varchar(100),code_lookup.lookup_code) and contains(code_lookup.code, '" + is_searchtext + "') or contains(ctx_custom_multi_detail.custom_34, '"+is_searchtext+"') )" + is_contracts
ls_sql += ls_select + "'Detail ('+ convert(varchar(100),ctx_custom_multi_detail.hdr_id) +','+convert(varchar(100),ctx_custom_multi_detail.detail_id) +') -> Custom 35' from ctx_custom_multi_detail "+&
		"where exists(select 1 from code_lookup where ctx_custom_multi_detail.custom_35 = convert(varchar(100),code_lookup.lookup_code) and contains(code_lookup.code, '" + is_searchtext + "') or contains(ctx_custom_multi_detail.custom_35, '"+is_searchtext+"') )" + is_contracts
ls_sql += ls_select + "'Detail ('+ convert(varchar(100),ctx_custom_multi_detail.hdr_id) +','+convert(varchar(100),ctx_custom_multi_detail.detail_id) +') -> Custom 36' from ctx_custom_multi_detail "+&
		"where exists(select 1 from code_lookup where ctx_custom_multi_detail.custom_36 = convert(varchar(100),code_lookup.lookup_code) and contains(code_lookup.code, '" + is_searchtext + "') or contains(ctx_custom_multi_detail.custom_36, '"+is_searchtext+"') )" + is_contracts
ls_sql += ls_select + "'Detail ('+ convert(varchar(100),ctx_custom_multi_detail.hdr_id) +','+convert(varchar(100),ctx_custom_multi_detail.detail_id) +') -> Custom 37' from ctx_custom_multi_detail "+&
		"where exists(select 1 from code_lookup where ctx_custom_multi_detail.custom_37 = convert(varchar(100),code_lookup.lookup_code) and contains(code_lookup.code, '" + is_searchtext + "') or contains(ctx_custom_multi_detail.custom_37, '"+is_searchtext+"') )" + is_contracts
ls_sql += ls_select + "'Detail ('+ convert(varchar(100),ctx_custom_multi_detail.hdr_id) +','+convert(varchar(100),ctx_custom_multi_detail.detail_id) +') -> Custom 38' from ctx_custom_multi_detail "+&
		"where exists(select 1 from code_lookup where ctx_custom_multi_detail.custom_38 = convert(varchar(100),code_lookup.lookup_code) and contains(code_lookup.code, '" + is_searchtext + "') or contains(ctx_custom_multi_detail.custom_38, '"+is_searchtext+"') )" + is_contracts
ls_sql += ls_select + "'Detail ('+ convert(varchar(100),ctx_custom_multi_detail.hdr_id) +','+convert(varchar(100),ctx_custom_multi_detail.detail_id) +') -> Custom 39' from ctx_custom_multi_detail "+&
		"where exists(select 1 from code_lookup where ctx_custom_multi_detail.custom_39 = convert(varchar(100),code_lookup.lookup_code) and contains(code_lookup.code, '" + is_searchtext + "') or contains(ctx_custom_multi_detail.custom_39, '"+is_searchtext+"') )" + is_contracts
ls_sql += ls_select + "'Detail ('+ convert(varchar(100),ctx_custom_multi_detail.hdr_id) +','+convert(varchar(100),ctx_custom_multi_detail.detail_id) +') -> Custom 40' from ctx_custom_multi_detail "+&
		"where exists(select 1 from code_lookup where ctx_custom_multi_detail.custom_40 = convert(varchar(100),code_lookup.lookup_code) and contains(code_lookup.code, '" + is_searchtext + "') or contains(ctx_custom_multi_detail.custom_40, '"+is_searchtext+"') )" + is_contracts
ls_sql += ls_select + "'Detail ('+ convert(varchar(100),ctx_custom_multi_detail.hdr_id) +','+convert(varchar(100),ctx_custom_multi_detail.detail_id) +') -> Custom 41' from ctx_custom_multi_detail "+&
		"where exists(select 1 from code_lookup where ctx_custom_multi_detail.custom_41 = convert(varchar(100),code_lookup.lookup_code) and contains(code_lookup.code, '" + is_searchtext + "') or contains(ctx_custom_multi_detail.custom_41, '"+is_searchtext+"') )" + is_contracts
ls_sql += ls_select + "'Detail ('+ convert(varchar(100),ctx_custom_multi_detail.hdr_id) +','+convert(varchar(100),ctx_custom_multi_detail.detail_id) +') -> Custom 42' from ctx_custom_multi_detail "+&
		"where exists(select 1 from code_lookup where ctx_custom_multi_detail.custom_42 = convert(varchar(100),code_lookup.lookup_code) and contains(code_lookup.code, '" + is_searchtext + "') or contains(ctx_custom_multi_detail.custom_42, '"+is_searchtext+"') )" + is_contracts
ls_sql += ls_select + "'Detail ('+ convert(varchar(100),ctx_custom_multi_detail.hdr_id) +','+convert(varchar(100),ctx_custom_multi_detail.detail_id) +') -> Custom 43' from ctx_custom_multi_detail "+&
		"where exists(select 1 from code_lookup where ctx_custom_multi_detail.custom_43 = convert(varchar(100),code_lookup.lookup_code) and contains(code_lookup.code, '" + is_searchtext + "') or contains(ctx_custom_multi_detail.custom_43, '"+is_searchtext+"') )" + is_contracts
ls_sql += ls_select + "'Detail ('+ convert(varchar(100),ctx_custom_multi_detail.hdr_id) +','+convert(varchar(100),ctx_custom_multi_detail.detail_id) +') -> Custom 44' from ctx_custom_multi_detail "+&
		"where exists(select 1 from code_lookup where ctx_custom_multi_detail.custom_44 = convert(varchar(100),code_lookup.lookup_code) and contains(code_lookup.code, '" + is_searchtext + "') or contains(ctx_custom_multi_detail.custom_44, '"+is_searchtext+"') )" + is_contracts
ls_sql += ls_select + "'Detail ('+ convert(varchar(100),ctx_custom_multi_detail.hdr_id) +','+convert(varchar(100),ctx_custom_multi_detail.detail_id) +') -> Custom 45' from ctx_custom_multi_detail "+&
		"where exists(select 1 from code_lookup where ctx_custom_multi_detail.custom_45 = convert(varchar(100),code_lookup.lookup_code) and contains(code_lookup.code, '" + is_searchtext + "') or contains(ctx_custom_multi_detail.custom_45, '"+is_searchtext+"') )" + is_contracts
ls_sql += ls_select + "'Detail ('+ convert(varchar(100),ctx_custom_multi_detail.hdr_id) +','+convert(varchar(100),ctx_custom_multi_detail.detail_id) +') -> Custom 46' from ctx_custom_multi_detail "+&
		"where exists(select 1 from code_lookup where ctx_custom_multi_detail.custom_46 = convert(varchar(100),code_lookup.lookup_code) and contains(code_lookup.code, '" + is_searchtext + "') or contains(ctx_custom_multi_detail.custom_46, '"+is_searchtext+"') )" + is_contracts
ls_sql += ls_select + "'Detail ('+ convert(varchar(100),ctx_custom_multi_detail.hdr_id) +','+convert(varchar(100),ctx_custom_multi_detail.detail_id) +') -> Custom 47' from ctx_custom_multi_detail "+&
		"where exists(select 1 from code_lookup where ctx_custom_multi_detail.custom_47 = convert(varchar(100),code_lookup.lookup_code) and contains(code_lookup.code, '" + is_searchtext + "') or contains(ctx_custom_multi_detail.custom_47, '"+is_searchtext+"') )" + is_contracts
ls_sql += ls_select + "'Detail ('+ convert(varchar(100),ctx_custom_multi_detail.hdr_id) +','+convert(varchar(100),ctx_custom_multi_detail.detail_id) +') -> Custom 48' from ctx_custom_multi_detail "+&
		"where exists(select 1 from code_lookup where ctx_custom_multi_detail.custom_48 = convert(varchar(100),code_lookup.lookup_code) and contains(code_lookup.code, '" + is_searchtext + "') or contains(ctx_custom_multi_detail.custom_48, '"+is_searchtext+"') )" + is_contracts
ls_sql += ls_select + "'Detail ('+ convert(varchar(100),ctx_custom_multi_detail.hdr_id) +','+convert(varchar(100),ctx_custom_multi_detail.detail_id) +') -> Custom 49' from ctx_custom_multi_detail "+&
		"where exists(select 1 from code_lookup where ctx_custom_multi_detail.custom_49 = convert(varchar(100),code_lookup.lookup_code) and contains(code_lookup.code, '" + is_searchtext + "') or contains(ctx_custom_multi_detail.custom_49, '"+is_searchtext+"') )" + is_contracts
ls_sql += ls_select + "'Detail ('+ convert(varchar(100),ctx_custom_multi_detail.hdr_id) +','+convert(varchar(100),ctx_custom_multi_detail.detail_id) +') -> Custom 50' from ctx_custom_multi_detail "+&
		"where exists(select 1 from code_lookup where ctx_custom_multi_detail.custom_50 = convert(varchar(100),code_lookup.lookup_code) and contains(code_lookup.code, '" + is_searchtext + "') or contains(ctx_custom_multi_detail.custom_50, '"+is_searchtext+"') )" + is_contracts
...
IF Isvalid(gw_contract) THEN
	...
	//Added By Alan on 2009-1-21  //modified by gavins 20160808
...
//	il_contract_array = iw_contract.tab_contract_details.tabpage_search.il_contract_array
	...
	gf_get_user_access_list( gs_user_id, ref il_contract_array  )
...
event pfc_postopen;call super::pfc_postopen;Post Event ue_auto_search() //Added by Ken.Guo 2008-08-04
end event
...
Long ll_RowCnt, ll_RowPos, ll_InsertRow
...
//added by gavins 20160808   search ctx id 
IF Isvalid(gw_contract) THEN
	ll_RowCnt = gw_contract.tab_contract_details.tabpage_search.ids_search.RowCount()
	ll_RowPos = gw_contract.tab_contract_details.tabpage_search.ids_search.Find("ctx_id = " + String(ll_ctx_id), 1, ll_RowCnt)
	if ll_RowCnt < 1 or ll_RowPos < 1 then
		...
		ll_InsertRow = gw_contract.tab_contract_details.tabpage_search.dw_search.InsertRow(0)
		//added by gavins 20160808
		If ll_ctx_id > 0 Then gw_contract.tab_contract_details.tabpage_search.dw_search.SetItem(  ll_InsertRow, 'ctx_id', ll_ctx_id )
		...
		ll_RowPos = gw_contract.tab_contract_details.tabpage_search.dw_search_det1.Find("ctx_id = " +String(ll_ctx_id), 1, ll_RowCnt)	
	end if
End If
// Get category
Long ll_category
...
//			ll_findrow = iw_contract.tab_contract_details.tabpage_images.tab_1.tabpage_data.tab_1.tabpage_browse.dw_browse.Find( "doc_id = " + String(ll_image_id), 1, 1000)
	...
	Case "locations"
		...
		Choose Case ls_colname
			...
			//Added by Harry 11-24-2016
			Case Lower('Group / Locations -> Custom 3')
				iw_contract.tab_contract_details.tabpage_locations.dw_detail.Setfocus( )
				iw_contract.tab_contract_details.tabpage_locations.dw_detail.Setcolumn( "ctx_loc_custom_3" )
			Case Lower('Group / Locations -> Custom 4')
				iw_contract.tab_contract_details.tabpage_locations.dw_detail.Setfocus( )
				iw_contract.tab_contract_details.tabpage_locations.dw_detail.Setcolumn( "ctx_loc_custom_4" )
			Case Lower('Group / Locations -> Local')
				iw_contract.tab_contract_details.tabpage_locations.dw_detail.Setfocus( )
				iw_contract.tab_contract_details.tabpage_locations.dw_detail.Setcolumn( "local" )
	...
	Case "fee schedule"
		...
		Choose Case ls_colname
			...
			//Added by Harry 11-24-2016
			Case Lower('Fee Schedules -> Custom 3')
				iw_contract.tab_contract_details.tabpage_fee_schedules.tab_1.tabpage_fee_browse.dw_main.Setfocus( )
				iw_contract.tab_contract_details.tabpage_fee_schedules.tab_1.tabpage_fee_browse.dw_main.Setcolumn( "custom_3" )
			Case Lower('Fee Schedules -> Custom 4')
				iw_contract.tab_contract_details.tabpage_fee_schedules.tab_1.tabpage_fee_browse.dw_main.Setfocus( )
				iw_contract.tab_contract_details.tabpage_fee_schedules.tab_1.tabpage_fee_browse.dw_main.Setcolumn( "custom_4" )
			Case Lower('Fee Schedules -> Custom 5')
				iw_contract.tab_contract_details.tabpage_fee_schedules.tab_1.tabpage_fee_browse.dw_main.Setfocus( )
				iw_contract.tab_contract_details.tabpage_fee_schedules.tab_1.tabpage_fee_browse.dw_main.Setcolumn( "custom_5" )
			Case Lower('Fee Schedules -> Notes')
				iw_contract.tab_contract_details.tabpage_fee_schedules.tab_1.tabpage_fee_notes.dw_1.Setfocus( )
				iw_contract.tab_contract_details.tabpage_fee_schedules.tab_1.tabpage_fee_notes.dw_1.Setcolumn( "notes" )
		End Choose
	...
	Case "action items"
		...
		Choose Case ls_colname
			...
			Case Lower('Subject')
				iw_contract.tab_contract_details.tabpage_action_items.tab_1.tabpage_detail.dw_1.SetFocus()
				iw_contract.tab_contract_details.tabpage_action_items.tab_1.tabpage_detail.dw_1.Setcolumn( "subject" )
		End Choose
		//Added by Harry 11-24-2016
		IF Left(ls_colname, 7) = 'custom ' THEN
			ls_colname = 'custom_' + mid(ls_colname, 8)
			iw_contract.tab_contract_details.tabpage_action_items.tab_1.tabpage_detail.dw_1.SetFocus()
			iw_contract.tab_contract_details.tabpage_action_items.tab_1.tabpage_detail.dw_1.Setcolumn(ls_colname )
		END IF
	Case "fee schedule (nm)"	//Added By Ken.Guo 2010-06-03.
		...
		Choose Case ls_colname
			Case Lower('Description')
				iw_contract.tab_contract_details.tabpage_fee_sched2.dw_fee_nm.Setfocus( )
				iw_contract.tab_contract_details.tabpage_fee_sched2.dw_fee_nm.Setcolumn( "description" )
			Case Lower('Category')
				iw_contract.tab_contract_details.tabpage_fee_sched2.dw_fee_nm.Setfocus( )
				iw_contract.tab_contract_details.tabpage_fee_sched2.dw_fee_nm.Setcolumn( "category" )
			Case Lower('Status')
				iw_contract.tab_contract_details.tabpage_fee_sched2.dw_fee_nm.Setfocus( )
				iw_contract.tab_contract_details.tabpage_fee_sched2.dw_fee_nm.Setcolumn( "item_status" )
			Case Lower('Service Item')
				iw_contract.tab_contract_details.tabpage_fee_sched2.dw_fee_nm.Setfocus( )
				iw_contract.tab_contract_details.tabpage_fee_sched2.dw_fee_nm.Setcolumn( "service_item" )
			Case Lower('Service Name')
				iw_contract.tab_contract_details.tabpage_fee_sched2.dw_fee_nm.Setfocus( )
				iw_contract.tab_contract_details.tabpage_fee_sched2.dw_fee_nm.Setcolumn( "service_name" )
			Case Lower('Notes')
				iw_contract.tab_contract_details.tabpage_fee_sched2.dw_fee_nm.Setfocus( )
				iw_contract.tab_contract_details.tabpage_fee_sched2.dw_fee_nm.Setcolumn( "notes" )
		End Choose
		IF Left(ls_colname, 7) = 'custom ' THEN
			IF mid(ls_colname, 8, 4) = 'text' THEN
				ls_colname = 'custom_' + mid(ls_colname, 8, 4) + mid(ls_colname, 13)
			ELSE
				ls_colname = 'custom_n' + Trim(mid(ls_colname, 8))
			END IF
			iw_contract.tab_contract_details.tabpage_fee_sched2.dw_fee_nm.Setfocus( )
			iw_contract.tab_contract_details.tabpage_fee_sched2.dw_fee_nm.Setcolumn( ls_colname )
		END IF
	Case "custom multi"    //Added By Ken.Guo 05/29/2012 //column format:Header (1) or Detail (1,1) -> Custom 1
		...
		ElseIf Pos(ls_colname, 'detail (') > 0 Then
			...
			iw_contract.tab_contract_details.tabpage_multi.Post of_locate_data( ll_hdr_id, ll_detail_id, ls_multi_col)
//			If ll_hdr_id > 0 Then
...
IF ls_tabname <> "detail" THEN
	...
	iw_contract.title = 'Contract Logix ' + ls_company + '        Contract ID: ' + String(ll_ctx_id)
END IF
...
//Added By Jay Chen 11-20-2014
string ls_checked
int i
if dwo.name = 'b_select' then
	for i = 1 to 10
		ls_checked = "searchin_" + String( i )
		//Added By Mark Lee 01/26/2015 
		if string(dw_term.Describe(ls_checked+".Protect")) <> "1" then 
			dw_term.SetItem(1, ls_checked, '1' )
		end if 
	next
end if
if dwo.name = 'b_unselect' then
	for i = 1 to 10
		ls_checked = "searchin_" + String( i )
		dw_term.SetItem(1, ls_checked, '0' )
	next
end if
//end add
end event
