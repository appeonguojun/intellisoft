...
type cbx_selected from checkbox within w_contract_tabprop_edit
end type
...
String is_default_selected //Added By Ken.Guo 2016-03-28
end variables
...
this.cbx_selected=create cbx_selected
...
this.Control[]={this.cbx_selected,&
this.ddlb_fontheight,&
this.cbx_fixedwidth,&
this.cbx_underline,&
this.cbx_italic,&
this.st_7,&
...
long ll_org_bkcolor, ll_org_textcolor
ll_org_bkcolor = st_tabbackcolor.backcolor
ll_org_textcolor = st_textcolor.backcolor
...
is_default_selected = gnv_user_option.of_get_viewid_option_value( il_data_view_id, 'View_Tab_Details_Default_Selected_TabID' , FALSE ) //Added By Ken.Guo 2016-03-28
...
//Added By Ken.Guo 2016-03-28
Choose Case is_tab_name 
	Case 'tabpage_det_custom'
		cbx_selected.visible = True
		If is_default_selected = '1' Then
			cbx_selected.checked = True
		End If
	Case 'tabpage_det_audit'
		cbx_selected.visible = True
		If is_default_selected = '2' Then
			cbx_selected.checked = True
		End If
	Case 'tabpage_det_notes'
		cbx_selected.visible = True
		If is_default_selected = '3' Then
			cbx_selected.checked = True
		End If
	Case 'tabpage_det_linked'
		cbx_selected.visible = True
		If is_default_selected = '4' Then
			cbx_selected.checked = True
		End If
	Case 'tabpage_det_group'
		cbx_selected.visible = True
		If is_default_selected = '5' Then
			cbx_selected.checked = True
		End If
End Choose
...
if SQLCA.SQLCode = 0 then
	...
	st_textcolor.BackColor = ll_org_textcolor
	st_backcolor.BackColor = ll_org_bkcolor
	st_tabbackcolor.BackColor = ll_org_bkcolor
end if
...
long backcolor = 67108864
string text = "Default Selected"
end type

event clicked;ib_Modified = True //Added By Ken.Guo 2016-03-28
end event
...
If ib_Modified Then
	If ll_Font_height = 0 Or isnull( ll_Font_height ) Then ll_Font_height = 8
	If trim(ls_FontName) = '' or isnull(ls_FontName) Then ls_FontName = 'MS Sans Serif'
	...
	If cbx_selected.visible Then
		Choose Case is_tab_name 
			Case 'tabpage_det_custom'
				If cbx_selected.checked  Then
					ls_default_selected = '1'
				ElseIf is_default_selected = '1' Then
					ls_default_selected = '' //selected none
				End If
			Case 'tabpage_det_audit'
				If cbx_selected.checked  Then
					ls_default_selected = '2'
				ElseIf is_default_selected = '2' Then
					ls_default_selected = '' //selected none
				End If
			Case 'tabpage_det_notes'
				If cbx_selected.checked  Then
					ls_default_selected = '3'
				ElseIf is_default_selected = '3' Then
					ls_default_selected = '' //selected none
				End If
			Case 'tabpage_det_linked'
				If cbx_selected.checked  Then
					ls_default_selected = '4'
				ElseIf is_default_selected = '4' Then
					ls_default_selected = '' //selected none
				End If
			Case 'tabpage_det_group'
				If cbx_selected.checked  Then
					ls_default_selected = '5'
				ElseIf is_default_selected = '5' Then
					ls_default_selected = '' //selected none
				End If
		End Choose
		gnv_user_option.of_set_viewid_option_value( il_data_view_id, 'View_Tab_Details_Default_Selected_TabID' ,ls_default_selected )
	End If
...
If ddlb_fontname.TotalItems() = 0 Then
	ddlb_fontname.addItem('MS Sans Serif')
End If
