...
type cbx_showbands from checkbox within uo_contract_design_menu
end type
type cb_controllist from commandbutton within uo_contract_design_menu
end type
type st_height from statictext within uo_contract_design_menu
end type
type st_width from statictext within uo_contract_design_menu
end type
type st_y from statictext within uo_contract_design_menu
end type
type st_x from statictext within uo_contract_design_menu
end type
...
type st_2 from statictext within uo_contract_design_menu
end type
type st_1 from statictext within uo_contract_design_menu
end type
end forward
...
cbx_showbands cbx_showbands
cb_controllist cb_controllist
st_height st_height
st_width st_width
st_y st_y
st_x st_x
...
if IsValid(inv_data_design) then
	...
	for ll_Cycle = 1 to ll_TotalCnts
		...
		if Not IsNull(ls_ObjName) and ls_ObjName <> '' then
			...
			inv_data_design.of_record_undolist(ls_Modify,ls_ObjName,'alignment')  //Added By Ken.Guo 2016-04-11
...
Long		ll_Cycle,ll_TotalCnts,ll_SelObjCnts
String	ls_ObjName,ls_Modify, ls_Type
...
if IsValid(inv_data_design) then
	...
	for ll_Cycle = 1 to ll_TotalCnts
		...
		ls_Type = inv_Data_Design.of_GetSelectedObjectType(ls_ObjName)
		if ls_Type <> "text" and ls_Type <> "compute" and ls_Type <> "column"  and ls_Type <> 'groupbox' and ls_Type <> 'button'  then Continue
		
		if Not IsNull(ls_ObjName) and ls_ObjName <> '' then
			ls_Modify = ls_ObjName + as_ProExp
			
			//Added By Ken.Guo 2016-04-11. for undo
			String ls_modify2, ls_object, ls_property
			ls_modify2 = Left(ls_Modify, Pos(ls_Modify, '=') - 1)
			ls_property = Mid(ls_modify2, Pos(ls_modify2, '.') + 1)
			inv_data_design.of_record_undolist(ls_Modify,ls_ObjName,ls_property) 
...
int iCurrent
call super::create
this.cbx_showbands=create cbx_showbands
this.cb_controllist=create cb_controllist
...
this.Control[iCurrent+1]=this.cbx_showbands
this.Control[iCurrent+2]=this.cb_controllist
this.Control[iCurrent+3]=this.st_height
this.Control[iCurrent+4]=this.st_width
this.Control[iCurrent+5]=this.st_y
this.Control[iCurrent+6]=this.st_x
this.Control[iCurrent+7]=this.st_gridtip
this.Control[iCurrent+8]=this.pb_show
this.Control[iCurrent+9]=this.pb_gridrectangle
this.Control[iCurrent+10]=this.pb_rectangle
this.Control[iCurrent+11]=this.pb_gridline
this.Control[iCurrent+12]=this.pb_gridtext
this.Control[iCurrent+13]=this.pb_gridcompute
this.Control[iCurrent+14]=this.pb_gridcolumn
this.Control[iCurrent+15]=this.p_alignleft
this.Control[iCurrent+16]=this.p_aligntop
this.Control[iCurrent+17]=this.p_sameheight
this.Control[iCurrent+18]=this.p_samewidth
this.Control[iCurrent+19]=this.pb_delete
this.Control[iCurrent+20]=this.pb_sort
this.Control[iCurrent+21]=this.pb_picture
this.Control[iCurrent+22]=this.pb_oval
this.Control[iCurrent+23]=this.pb_groupbox
this.Control[iCurrent+24]=this.p_aligntop_1
this.Control[iCurrent+25]=this.p_copysize
this.Control[iCurrent+26]=this.st_11
this.Control[iCurrent+27]=this.st_object_name
...
this.Control[iCurrent+32]=this.st_underline
this.Control[iCurrent+33]=this.st_italic
this.Control[iCurrent+34]=this.st_bold
this.Control[iCurrent+35]=this.st_right
this.Control[iCurrent+36]=this.st_center
this.Control[iCurrent+37]=this.st_left
this.Control[iCurrent+38]=this.st_relocate_field
this.Control[iCurrent+39]=this.dw_1
this.Control[iCurrent+40]=this.r_6
this.Control[iCurrent+41]=this.r_1
this.Control[iCurrent+42]=this.r_2
this.Control[iCurrent+43]=this.r_3
this.Control[iCurrent+44]=this.r_4
this.Control[iCurrent+45]=this.p_1
this.Control[iCurrent+46]=this.p_alignleft_1
this.Control[iCurrent+47]=this.st_7
this.Control[iCurrent+48]=this.st_tab_order
this.Control[iCurrent+49]=this.st_copysize
this.Control[iCurrent+50]=this.st_aligntop
this.Control[iCurrent+51]=this.st_12
this.Control[iCurrent+52]=this.st_alignleft
this.Control[iCurrent+53]=this.r_5
this.Control[iCurrent+54]=this.pb_column
this.Control[iCurrent+55]=this.pb_text
this.Control[iCurrent+56]=this.pb_compute
this.Control[iCurrent+57]=this.st_3
this.Control[iCurrent+58]=this.st_4
this.Control[iCurrent+59]=this.hsb_1
this.Control[iCurrent+60]=this.hsb_2
this.Control[iCurrent+61]=this.p_bold
this.Control[iCurrent+62]=this.p_italic
this.Control[iCurrent+63]=this.p_underline
this.Control[iCurrent+64]=this.p_left
this.Control[iCurrent+65]=this.p_center
this.Control[iCurrent+66]=this.p_right
this.Control[iCurrent+67]=this.st_show_invisible
this.Control[iCurrent+68]=this.pb_gridoval
this.Control[iCurrent+69]=this.pb_gridpicture
this.Control[iCurrent+70]=this.pb_line
this.Control[iCurrent+71]=this.st_2
this.Control[iCurrent+72]=this.st_1
end on

on uo_contract_design_menu.destroy
call super::destroy
destroy(this.cbx_showbands)
destroy(this.cb_controllist)
...
event constructor;call super::constructor;string 			ls_tmp

//Added By Mark Lee 09/22/2015
ls_tmp = gnv_user_option.of_get_option_value(gs_user_id, "Screen_Design_Show_More_Bands" ) 
if not isnull(ls_tmp) and trim(ls_tmp) = '1' then 
	cbx_showbands.checked = true
else
	cbx_showbands.checked = false
end if 
end event
...
//Added By Ken.Guo 2015-05-13
if IsValid(inv_data_design) then
	inv_data_design.of_show_more_bands( this.checked)
	inv_data_design.Dynamic Trigger Event ue_showmoreband()
	...
	gnv_user_option.of_Set_option_value(gs_user_id, "Screen_Design_Show_More_Bands",ls_check )
...
fontfamily fontfamily = swiss!
string facename = "MS Sans Serif"
string text = "Control List"
end type

event clicked;//Added By Ken.Guo 09/16/2014
if IsValid(inv_data_design) then
	inv_data_design.Dynamic Trigger Event ue_controllist()
end if
end event
...
Elseif inv_data_design.is_open_style = "screen" and ( inv_data_design.ii_Screen_id =31 ) then 
	...
	inv_data_design.Post of_AutoUpdateSearchScreen(is_CurObj, ls_TObj )		
Elseif inv_data_design.is_open_style = "screen" and ( inv_data_design.ii_Screen_id =10 ) then  //Added By Jay Chen 07-03-2014
	ls_TObj = 'custom2_' + is_CurObj
	inv_data_design.Post of_AutoUpdateSearchScreen(is_CurObj, ls_TObj )	
	inv_data_design.Post of_AutoUpdateDetailScreen(is_CurObj)
Else
...
string ls_sync_screen_contact
long ll_AlwaysUpdate,ll_RtnVal,ll_rtn
if inv_data_design.is_open_style = "screen" and ( inv_data_design.ii_Screen_id = 6 Or inv_data_design.ii_Screen_id = 7 or inv_data_design.ii_Screen_id = 1) then 
	...
	if ls_sync_screen_contact = '1' then
		if left(lower(is_CurObj),20) = 'ctx_contacts_custom_' or left(lower(is_CurObj),20) = 'app_facility_custom_' then
			//Added By Jay Chen 12-15-2015
...
//			if Messagebox("Confirm Sync","Do you want to sync the labels and style to the Contact Window?",Question!,YesNo!) = 1 then
				inv_data_design.of_auto_update_contact_custom(is_CurObj)
				//Added By Jay Chen 11-30-2015 sync search screen and contract contact screen
				if left(lower(is_CurObj),20) = 'app_facility_custom_' then
					if inv_data_design.ii_Screen_id = 1 then
						inv_data_design.of_auto_update_contactsyntax(6, is_CurObj)
						inv_data_design.of_auto_update_contactsyntax(7, is_CurObj)
					elseif inv_data_design.ii_Screen_id = 6 then
						inv_data_design.of_auto_update_contactsyntax(1, is_CurObj)
						inv_data_design.of_auto_update_contactsyntax(7, is_CurObj)
...
for ll_Cycle = 1 to ll_TotalCnts
	...
	if ls_Type = 'compute' or ls_ColName = "?" or ls_ColName = "!" then
		inv_Data_Design.istr_SelectObj[ll_Cycle].FBand.Modify(ls_ObjName + ls_Syntax)
		inv_data_design.of_record_undolist(ls_ObjName + ls_Syntax,ls_ObjName,'font.underline') //Added By Ken.Guo 2016-04-11
		inv_Data_Design.Event ue_SetModify(ls_ObjName + ls_Syntax)
	else
		if ll_Rtn <> 0 and ll_Rtn <> 1 then Continue
		...
		inv_data_design.of_record_undolist(ls_Modify,ls_ColName,ls_EditStyle + ".Required") //Added By Ken.Guo 2016-04-11
		inv_data_design.of_record_undolist( ls_ColName + "_t" + ls_Syntax, ls_ColName + "_t", "font.underline") //Added By Ken.Guo 2016-04-11
		ls_Modify += " " + ls_ColName + "_t" + ls_Syntax
