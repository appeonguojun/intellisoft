...
if ls_parm = 'A' then
	...
	is_add = 'M'
	ll_view_id = long(mid(ls_parm,1,pos(ls_parm,'+') - 1))
	ll_screen_id = long(mid(ls_parm,pos(ls_parm,'+') + 1,len(ls_parm)))
...
event clicked;string ls_dataobject,ls_sql,ls_tab_name,ls_dw_name,ls_sql1,ls_sql2, ls_style
