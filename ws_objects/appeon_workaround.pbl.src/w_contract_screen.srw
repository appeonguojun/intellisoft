...
dw_1.Modify( "data_view_id.visible=0 data_view_id_t.visible=0" )
...
event clicked;//modified by gavins 20120312  support grid
//

long ll_rowcount,ll_i,ll_screen_id,ll_rowcount1,ll_j,ll_ck
string ls_sql,ls_dataobject, ls_ScreenStyle, ls_griddataobject, ls_fixField, ls_lookuplist, ls_dw_opsyntax, ls_err_text=''
