...
ELSE
	...
	FOR ll_i = 1 TO UpperBound(Data)
		ll_bloblenarr[ll_i] = Len(Data[ll_i])
	NEXT
...
ELSE
	...
	ELSE
		ll_ret = RegStruArrayA(il_srvId, Data, lbl_Send, Len(lbl_Send), javaclassname, UpperBound(Data))
...
ELSE
	...
	IF ll_ret = -1 THEN
		...
		MessageBox(ERR_WARNING, ls_RetErr, Exclamation!, OK!)
	ELSE
		ll_ret = RegStruA(il_srvId, Data, lbl_Send, javaclassname, Len(lbl_Send))
