$PBExportHeader$w_contract_copyscreen1.srw
forward
global type w_contract_copyscreen1 from window
end type
type cb_cancel from commandbutton within w_contract_copyscreen1
end type
type cb_ok from commandbutton within w_contract_copyscreen1
end type
type dw_view from u_dw within w_contract_copyscreen1
end type
type st_2 from statictext within w_contract_copyscreen1
end type
type sle_screen from singlelineedit within w_contract_copyscreen1
end type
type st_1 from statictext within w_contract_copyscreen1
end type
end forward
...
global w_contract_copyscreen1 w_contract_copyscreen1

type variables
string is_Return = "cancel!"
end variables

on w_contract_copyscreen1.create
...
on w_contract_copyscreen1.destroy
