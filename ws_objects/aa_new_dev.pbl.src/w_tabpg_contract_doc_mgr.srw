...
//		ldwc_dddw.filter( )
			...
			Else
				...
				If uo_2.ole_word.object.doctype > 0 Then uo_2.ole_word.object.ActiveDocument.Saved = True //Added By Ken.Guo 2016-05-23. workaround Task 524
...
//uo_2.uo_1.of_set_readonly( True)
