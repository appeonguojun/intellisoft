...
type cbx_display_multi_product from checkbox within w_contract_display_setting
end type
...
boolean center = true
cbx_display_multi_product cbx_display_multi_product
...
boolean ib_display_multi_product = false //Added By Jay Chen 11-12-2014
end variables

on w_contract_display_setting.create
int iCurrent
call super::create
this.cbx_display_multi_product=create cbx_display_multi_product
...
this.Control[iCurrent+1]=this.cbx_display_multi_product
this.Control[iCurrent+2]=this.rb_to_do_list_right
this.Control[iCurrent+3]=this.rb_to_do_list_left
this.Control[iCurrent+4]=this.st_to_do_list
this.Control[iCurrent+5]=this.cbx_to_do_list
this.Control[iCurrent+6]=this.rb_document_right
this.Control[iCurrent+7]=this.rb_document_left
this.Control[iCurrent+8]=this.st_parent_child_tree
this.Control[iCurrent+9]=this.st_document_preview
this.Control[iCurrent+10]=this.cbx_powerfilter
this.Control[iCurrent+11]=this.rb_standard_results_list
this.Control[iCurrent+12]=this.rb_calendar
this.Control[iCurrent+13]=this.cb_close
this.Control[iCurrent+14]=this.cbx_search_criteria
this.Control[iCurrent+15]=this.cbx_display_document_preview
this.Control[iCurrent+16]=this.cbx_display_contract_parent_child_tree
this.Control[iCurrent+17]=this.cb_apply
this.Control[iCurrent+18]=this.gb_browse_screen
this.Control[iCurrent+19]=this.gb_pane_settings
this.Control[iCurrent+20]=this.gb_to_do_list
this.Control[iCurrent+21]=this.gb_document
this.Control[iCurrent+22]=this.rb_tree_right
this.Control[iCurrent+23]=this.rb_tree_left
this.Control[iCurrent+24]=this.gb_parent_child_tree
this.Control[iCurrent+25]=this.gb_position_settings
end on

on w_contract_display_setting.destroy
call super::destroy
destroy(this.cbx_display_multi_product)
...
//Added By Jay Chen 11-12-2014
string ls_display_multi_product
ls_display_multi_product = gnv_user_option.of_Get_option_value( gs_user_id, "display_multi_product" )
if isnull(ls_display_multi_product) or ls_display_multi_product = '' then ls_display_multi_product = '1'
If ls_display_multi_product = '1' Then
	cbx_display_multi_product.checked = true
Else
	cbx_display_multi_product.checked = false
End If
//end
end event
...
string text = "Display Multi - Products"
end type

event clicked;ibn_Modified = true
ib_display_multi_product = true
end event
...
If ibn_Modified = True Then	
	...
	//Added By Jay Chen 11-12-2014
	string ls_display_multi_product
	if cbx_display_multi_product.checked then
		ls_display_multi_product = '1'
	else
		ls_display_multi_product = '0'
	end if
	gnv_user_option.of_Set_option_value(gs_user_id, "display_multi_product",ls_display_multi_product)
	//end
...
Else
	If isvalid(gw_contract) Then
		...
		gw_contract.tab_contract_details.tabpage_search.of_page_toolbar() //Added By Jay Chen 05-14-2015
		//Added By Jay Chen 11-13-2014
		if ib_display_multi_product then
