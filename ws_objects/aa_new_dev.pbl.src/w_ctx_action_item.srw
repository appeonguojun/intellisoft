...
//Added By Jay Chen 08-10-2015 Action items can be viewed but not changed when calendar is read only
If w_mdi.of_security_access( 6957 ) = 1 Then
	cb_ok.enabled = False
	dw_action_item.object.datawindow.readonly = true
	dw_action_item.modify("b_notes.enabled = false")
End If
end event
