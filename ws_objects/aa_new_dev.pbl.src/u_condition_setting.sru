...
this.Control[iCurrent+6]=this.rb_actions
this.Control[iCurrent+7]=this.st_entrytype
this.Control[iCurrent+8]=this.rb_customcriteria
this.Control[iCurrent+9]=this.rb_currentrecord
this.Control[iCurrent+10]=this.rb_allrecords
this.Control[iCurrent+11]=this.st_records
this.Control[iCurrent+12]=this.gb_records
this.Control[iCurrent+13]=this.gb_entrytype
end on
