...
type oval_audit from oval within pfc_cst_u_app_status
end type
type r_2 from rectangle within pfc_cst_u_app_status
end type
type oval_de from oval within pfc_cst_u_app_status
end type
type r_3 from rectangle within pfc_cst_u_app_status
end type
type oval_verif from oval within pfc_cst_u_app_status
end type
type r_4 from rectangle within pfc_cst_u_app_status
end type
type oval_approval from oval within pfc_cst_u_app_status
end type
end forward
