...
type tab_1 from tab within w_privilege_report
end type
...
type st_2 from statictext within w_privilege_report
end type
type st_f from statictext within w_privilege_report
end type
end forward
...
this.Control[iCurrent+4]=this.cb_run_report
this.Control[iCurrent+5]=this.cb_printreport
this.Control[iCurrent+6]=this.dw_stat
this.Control[iCurrent+7]=this.st_2
this.Control[iCurrent+8]=this.st_f
end on
...
tab_1.tabpage_report.dw_print.settransobject(sqlca)
cnt = tab_1.tabpage_report.dw_print.retrieve(il_priv_id,ll_stats)
