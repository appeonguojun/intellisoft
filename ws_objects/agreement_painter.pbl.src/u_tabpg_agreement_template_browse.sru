...
type dw_output from u_dw within u_tabpg_agreement_template_browse
end type
...
boolean	ibn_refresh_output	= false			 	//Added By Mark Lee 10/28/2015
end variables
...
public subroutine of_copy_data ()
end prototypes
...
//ls_filter += "and (deleted is null or deleted <> 'Y')  "																				//Added By Mark Lee 07/15/2015
...
public subroutine of_copy_data ();long		i, ll_rowcount, ll_row
...
if dw_browse.rowcount( ) > 0 then 
	...
	for i = 1 to ll_rowcount
		ll_row = dw_output.insertrow(0)
		dw_output.SetItem(ll_row, "no", dw_browse.GetItemnumber( i, "compute_1"))
		dw_output.SetItem(ll_row, "template_name",dw_browse.GetItemString( i, "template_name"))
		dw_output.SetItem(ll_row, "reviewed_by",dw_browse.GetItemString( i, "reviewed_by"))
		dw_output.SetItem(ll_row, "date_reviewed",dw_browse.GetItemDatetime( i, "date_reviewed"))
		dw_output.SetItem(ll_row, "review_status",dw_browse.GetItemString( i, "reviewed_status_name"))
		dw_output.SetItem(ll_row, "last_modified",dw_browse.GetItemDatetime( i, "modify_date"))
	next 
end if 

ibn_refresh_output  = false
end subroutine
...
integer height = 560
integer taborder = 50
string dataobject = "d_agreement_template_browse_output"
end type

event constructor;call super::constructor;this.Modify("DataWindow.zoom=100")				//Added By Mark Lee 10/28/2015 
...
event rbuttondown;call super::rbuttondown;//Added By Mark Lee 10/28/2015			
if ibn_refresh_output = true or dw_output.rowcount() <= 0 then 
	of_copy_data() 
end if 

//dw_output.Modify("DataWindow.zoom=100")

m_npdb_options NewMenu 
NewMenu = CREATE m_npdb_options
NewMenu.of_setparent(dw_output)
