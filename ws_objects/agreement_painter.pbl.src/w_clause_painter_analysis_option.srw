...
//End If 
ls_tmp = gnv_user_option.of_Get_option_value( "contractlogix-super-master", "Last_Full_Clause_Analysis_date_for_temp_usage" )
If Not(isnull(ls_tmp) or ls_tmp = '') Then
	cbx_template_usage.text = cbx_template_usage.text +"(Last Full Analysis: "+String(ls_tmp)+")"
End If 
ls_tmp = gnv_user_option.of_Get_option_value( "contractlogix-super-master", "Last_Full_Clause_Analysis_date_for_dm_usage" )
If Not(isnull(ls_tmp) or ls_tmp = '') Then
	cbx_dm_usage.text = cbx_dm_usage.text +"(Last Full Analysis: "+String(ls_tmp)+")"
End If 
ls_tmp = gnv_user_option.of_Get_option_value( "contractlogix-super-master", "Last_Full_Clause_Analysis_date_for_negotiated" )
If Not(isnull(ls_tmp) or ls_tmp = '') Then
