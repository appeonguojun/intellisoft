...
type dw_pend_clause from datawindow within w_agreement_template_add_clause
end type
...
//Modified By Jay Chen 01-28-2014
...
//			tab_1.tabpage_1.ds_clause_included.reset() //Modified By Jay Chen 01-28-2014
...
//		tab_1.tabpage_1.ds_clause_included.reset() //Modified By Jay Chen 02-12-2014
...
long li_row,ll_num1,ll_num2,ll_selected_clauseid[] //Added By Jay Chen 02-11-2014

//ll_row = dw_selected.getrow()
//if ll_row < 1 then return 

//Modified By Jay Chen 02-11-2014
if dw_selected.rowcount() < 1 then return
for li_row = dw_selected.rowcount() to 1 step -1
	if dw_selected.isselected(li_row) then 
		ll_selected_clauseid[upperbound(ll_selected_clauseid) + 1] = dw_selected.object.ctx_acp_clause_id[li_row]
	end if
next

for li_row = 1 to upperbound(ll_selected_clauseid)
...
if of_get_clause_file(ll_clause_id,ldt_modify_date) = -1 then 
	messagebox("ContractLogix","Can't finish adding clause(s) to template file due to getting clause file(s) failed!" )
	return -1
end if
...
if sqlca.sqlcode <> 0 then 
	messagebox("ContractLogix","Can't finish adding clause(s) to template file due to database updating failed!")
	return -1
end if
...
this.Control[iCurrent+5]=this.dw_formula
this.Control[iCurrent+6]=this.st_vsplitbar
this.Control[iCurrent+7]=this.cb_rules
this.Control[iCurrent+8]=this.cbx_preview
this.Control[iCurrent+9]=this.tab_1
this.Control[iCurrent+10]=this.cb_move_down
this.Control[iCurrent+11]=this.cb_move_up
this.Control[iCurrent+12]=this.cb_move_left
this.Control[iCurrent+13]=this.cb_move_right
this.Control[iCurrent+14]=this.gb_1
this.Control[iCurrent+15]=this.gb_2
this.Control[iCurrent+16]=this.cb_cancel
this.Control[iCurrent+17]=this.dw_selected
this.Control[iCurrent+18]=this.gb_3
this.Control[iCurrent+19]=this.cb_add
this.Control[iCurrent+20]=this.cb_resize
end on
...

