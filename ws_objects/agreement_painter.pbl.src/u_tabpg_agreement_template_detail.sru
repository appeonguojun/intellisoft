...
public function integer of_template_maponoff (boolean ab_flag)
...
if ab_flag then 
	...
	ole_1.X = tv_Clause.X + tv_Clause.Width + 20
//	ole_1.Height = dw_Formula.Y - ole_1.Y - 20
	ole_1.Height = cbx_dynclauserules.Y + cbx_dynclauserules.Height - ole_1.y
	tv_Clause.height = ole_1.Height
	...
	if isvalid(m_pfe_cst_clause_painter) then
		gnv_app.of_modify_menu_attr( m_pfe_cst_clause_painter.m_file.m_map,'toolbaritemdown', true)
	end if
else
	ole_1.Width = This.Width - tv_Clause.X - 18
	ole_1.X = tv_Clause.X
	...
	if isvalid(m_pfe_cst_clause_painter) then
		gnv_app.of_modify_menu_attr( m_pfe_cst_clause_painter.m_file.m_map,'toolbaritemdown', false)
	end if
end if
...
//cb_Properties.Visible = ab_flag and cbx_DynClauseRules.Checked
//cbx_DynClauseRules.Visible = ab_flag
cbx_dynclauserules.visible = false
cb_properties.visible = false
dw_Formula.Visible = false
of_DispClauseRules(false)
//of_DispClauseRules(dw_Formula.Visible)
...
gnv_app.of_modify_menu_attr( m_pfe_cst_clause_painter.m_file.m_save,'enabled', False) //Added By Jay Chen 09-16-2014
...
//Added By Jay Chen 09-12-2014 initialize document object
...
event selectionchanged;call super::selectionchanged;long	ll_Found,ll_clause_id,ll_template_id
...
if tv_Clause.GetItem(NewHandle,ltvi_Item) = 1 then
	if ltvi_Item.PictureIndex <> 1 then		//clause
		...
		if ll_Found > 0 then
			...
			if AppeonGetClientType() = 'WEB' then //Added By Jay Chen 03-06-2015
				if dw_Clause.RowCount() = 1 then
					dw_Clause.triggerevent (rowfocuschanged!) 
				end if
			end if
		end if
		of_RefreshClauseRules()
...

