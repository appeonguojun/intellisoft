...
choose case Lower(ls_type	)
	...
	case 'doc','xls','csv' //Alfee 05.19.2008
		...
		if ll_doc_id <> il_currentopened then
			...
			If tab_1.tabpage_document.ole_word.object.doctype > 0 Then tab_1.tabpage_document.ole_word.object.ActiveDocument.Saved = True //Added By Ken.Guo 2016-05-23. workaround Task 524
...
//			+ "All Files (*.*), *.*" )	
		li_return = ln_getfilename.of_getopenfilename ( "Select File", ls_fullname, ls_filename, "DOC", &
			+ "Doc Files (*.DOCX;*.DOC),*.DOCX;*.DOC," &
			+ "All Files (*.*), *.*" )	
	case 'TIF'
...
//			+ "Tif Files (*.TIF),*.TIF," &
//			+ "All Files (*.*), *.*" )
		li_return = ln_getfilename.of_getopenfilename( "Select File", ls_fullname, ls_filename, "TIF", &
			+ "Tif Files (*.TIF),*.TIF," &
			+ "All Files (*.*), *.*" )
	case 'XLS'
...
//			+ "Excel Files (*.XLS),*.XLS," &
//			+ "All Files (*.*), *.*" )
		li_return = ln_getfilename.of_getopenfilename( "Select File", ls_fullname, ls_filename, "XLS", &
			+ "Excel Files (*.XLS),*.XLS," &
			+ "All Files (*.*), *.*" )
	case else 
//		li_return = GetFileOpenName ( "Select File", ls_fullname, ls_filename, "*.*", &
//			+ "All Files (*.*), *.*")
		li_return = ln_getfilename.of_getopenfilename( "Select File", ls_fullname, ls_filename, "*.*", &
			+ "All Files (*.*), *.*")
End Choose
/*
...
//li_return = gnv_appeondll.of_Registryget("HKEY_LOCAL_MACHINE\SOFTWARE\"+gs_DefDirName+"\Agreement", 'Document-' + string( ll_doc_id ), regstring!, ls_lastopen)
 gnv_filetime.of_getlastwritedatetime( ls_fullname, ls_lastopen)
...
IF ll_length > 0 THEN
	IF gs_dbtype = "SQL" and appeongetclienttype() = "PB" and ll_length > 8000 THEN
		...
		For li_Cnt = 1 To li_loops				
			...
			IF SQLCA.SQLCode <> 0 THEN
				IF Isvalid( w_appeon_gifofwait) THEN Close( w_appeon_gifofwait)
				Messagebox( "ContractLogix", "Read file data from database failed." )
				Return "";
			END IF
			lblb_doc += lblb_data
		Next 
	...
	If li_FileNo < 0 Then
		IF Isvalid( w_appeon_gifofwait) THEN Close( w_appeon_gifofwait)
		Messagebox( "ContractLogix", "Create temporary file failed." )
		Return ""
	End If
	...
	For li_Cnt = 1 To li_Writes
		...
		If FileWrite(li_FileNo, lblb_Data) = -1 Then
			IF Isvalid( w_appeon_gifofwait) THEN Close( w_appeon_gifofwait)
			Messagebox( "ContractLogix", "Write temporary file failed." )
			Return "";
		End if
	Next
...
ELSE
	IF Isvalid( w_appeon_gifofwait) THEN Close( w_appeon_gifofwait)
	Messagebox( "ContractLogix", "Attached file not stored in database." )
	Return "";
END IF

IF Not FileExists(ls_fullname) THEN Return ""; //Alfee 08.21.2007

//Added By Ken.Guo 2015-04-29
 gnv_filetime.of_setlastwritedatetime( ls_fullname, ldt_lastmodify)
...
event closequery;call super::closequery;If tab_1.tabpage_document.ole_word.object.doctype > 0 Then tab_1.tabpage_document.ole_word.object.ActiveDocument.Saved = True //Added By Ken.Guo 2016-05-23. workaround Task 524
tab_1.tabpage_document.ole_word.object.close()
end event
...

