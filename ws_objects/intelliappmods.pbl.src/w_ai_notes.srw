...
type cb_3 from commandbutton within w_ai_notes
end type
type rte_1 from richtextedit within w_ai_notes
end type
...
integer width = 1426
integer height = 1820
string title = "Action Items Note"
...
event open;call super::open;//mle_note.Text = Message.StringParm //Modified By Jay Chen 05-16-2014
string ls_notes
