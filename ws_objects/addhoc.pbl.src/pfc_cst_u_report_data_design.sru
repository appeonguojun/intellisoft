...
//end if
if ll_count=0 then
	insert ctx_report_syntax(view_id,dw_sql,modify_date,dw_select) values(:il_view_id,:ls_dw_syntax,:ldt_today, :ls_dw_select);
else
	update ctx_report_syntax set dw_sql = :ls_dw_syntax,modify_date=:ldt_today,dw_select =:ls_dw_select where view_id=:il_view_id;
end if
