...
event key;If Key = KeyEscape! and ib_EnableCancel Then
	If Messagebox('Contract Logix','Do you want to cancel the action?',Question!,YesNo!) = 1 Then
		Close(This)
	End If
End If
