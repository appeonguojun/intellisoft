...
//messagebox("", gs_dir_path + gs_DefDirName + "\capture.bat" )
...
IF li_filenum = -1 THEN
	//MessageBox("Error", "Could not open file " + gs_dir_path + gs_DefDirName + "\capture.bat.  This file is need to capture images. See your users manual for assistance." )
	MessageBox("Error", "Could not open file " + gs_dir_path + gs_DefDirName + "\capture.bat.  This file is needed to capture images. See your users manual for assistance." )
	Close( This )
	Return -1
END IF
...
li_FileNum1 = FileOpen( gs_dir_path + gs_DefDirName + "\capture.bat" , LineMode!, Read!, LockWrite!, Replace!)
