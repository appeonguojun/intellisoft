...
integer x = 1833
string item[] = {"Expiration Letters Needing Printing","Expiration Letters Awaiting Response","All Action Items For A Practitioner","Incomplete App Audit Items"}
...
IF newindex = 2 AND tab_1.tabpage_detail.tab_view.tabpage_browse.dw_browse.RowCount() = 0 THEN
	...
	dw_select_org_facility.Modify( "facilities_t.Text = 'Select Payor/Hospital'")
	Return 0
