...
//		value = GetFileOpenName("Select File", docname, named, ls_ext, "Cover Page Files (*."+ls_ext+"),*."+ls_ext)
		value = ln_getfilename.of_getopenfilename( "Select File", docname, named, ls_ext, "Cover Page Files (*."+ls_ext+"),*."+ls_ext)
		...
		IF value > 0 THEN
			...
			if len(iblob_coverfile) = 0 or isnull(iblob_coverfile) then
...
//		value = GetFileSaveName ( 'Save File', ls_pathname, ls_cover_sheet ,ls_ext, "Cover Page Files (*."+ls_ext+"),*."+ls_ext)
		value =  ln_getfilename.of_getsavefilename(  'Save File', ls_pathname, ls_cover_sheet ,ls_ext, "Cover Page Files (*."+ls_ext+"),*."+ls_ext)
