...
choose case dwo.name
	case 'app_from'		
		...
		ldt = inv_datetime.of_relativeyear (date(data), 2 )
...
ret = string(ll_code) + ";" + string(ls_dt_rdate) + ";" + string(ls_dt_sdate) + ";" + string(ls_dt_edate) + ";" + string(ls_dt_pstart) + ";" + string(ls_dt_pend) + ";" + string(li_prov)
