...
//li_microhelpheight = of_CalculateMicroHelpHeight() //modify by gavins 20130510
...
public subroutine of_set_statusbar_dw (datawindow adw_statusbar);idw_Statusbar = adw_statusbar
end subroutine
