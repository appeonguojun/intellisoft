...
//li_rtn = GetFileOpenName("Select File",    docpath, docname,   "Text File (*.TXT),*.TXT,"  ,   "Text Files (*.*), *.*")		//Added By Mark Lee 08/15/2014
n_getfilename     ln_getfilename
li_rtn = ln_getfilename.of_getopenfilename("Select File",&
                docpath, docname,   "Text File (*.TXT),*.TXT,"  ,   "Text Files (*.*), *.*")	
