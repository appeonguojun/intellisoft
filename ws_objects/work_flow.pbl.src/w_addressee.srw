...
sle_Mail.SelectText(Len(ls_Text),0)
...
if Not IsNull(ls_StrParm) then
	ls_Type = Mid(ls_StrParm,2,Pos(ls_StrParm,")")-2)
	cb_add.Text += ls_Type
	
	ls_Mail = Mid(ls_StrParm,Pos(ls_StrParm,")")+1)
...
event ue_enter;This.SelectText(1,len(This.GetText()))
This.Post SetFocus()
