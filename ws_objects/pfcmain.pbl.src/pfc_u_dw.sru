...
Boolean		ib_move_dw = False			//Added By Mark Lee 01/07/2013
...
//Begin - Added By Mark Lee 12/27/2012
//This.ScrollToRow(ll_rc)
If this.rowcount( ) > 1 Then 
	This.ScrollToRow(ll_rc)
End If
//End - Added By Mark Lee 12/27/2012
This.SetFocus()
This.SetColumn(1)
...
if IsValid (lds_selection) then
	...
	If appeongetclienttype() = 'WEB' Then
		if Object.DataWindow.Print.FileName = "" then
			ls_val = gs_dir_path + gs_DefDirName + '\' + "Print.PDF"
...
//Begin - Added By Mark Lee 07/30/12	comment this , because the of_PrintDlg funcation can't used in the web
If appeongetclienttype() <> 'PB' Then
	RETURN PrintSetup( ) 
End If
//End - Added By Mark Lee 07/30/12
...
//			"Printer Files,*.prn,All Files,*.*") <= 0 then
		if ln_getfilename.of_getsavefilename	("Print to File", ls_pathname, ls_filename, "prn", &
			"Printer Files,*.prn,All Files,*.*") <= 0 then
...
string	ls_msgparm[2]	,	ls_styletype, ls_Title
integer	li_rc
...
// PowerBuilder Foundation Classes (PFC) source code by other than Sybase, Inc. and its subsidiaries is prohibited.
//////////////////////////////////////////////////////////////////////////////
If Not gb_autozoom Then Return //added by gavins 20130107
