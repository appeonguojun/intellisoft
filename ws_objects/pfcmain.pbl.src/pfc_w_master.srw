...
If IsValid (inv_resize) and This.windowstate <> minimized! Then
	If AppeonGetClientType() = 'WEB' and lenv.osmajorrevision = 6 and lenv.osminorrevision = 0 Then //Added By Ken.Guo 2009-09-15.
		inv_resize.Event pfc_Resize (sizetype, This.WorkSpaceWidth() - 25, This.WorkSpaceHeight() - 25)
	Else
