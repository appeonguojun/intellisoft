...
String is_screen_version = '0130'	////Modified By Harry 2017-07-13
...
public function integer of_update_field_initial (datastore ads_target, datastore ads_source)
end prototypes
...
CHOOSE CASE al_screen_id 
	CASE 1
		ads_source.Modify( "owner.dddw.DisplayColumn = 'user_name'" ) //added by gavins 20160504 , jay forgot to add, maybe, i do no see requirement.
	CASE 9
		ls_temp = "custom_date"
		FOR ll_i = 1 to 15
	...
	CASE 12,13
		...
		ads_source.Modify(ls_Modify)
	CASE 32
		ls_Modify = "doc_type.Initial='null' " //create_by.dddw.DisplayColumn = 'user_name' status_by.dddw.DisplayColumn = 'user_name'"  modified by gavins 20160504 i do not add it , because upgrade slow and customer do not required.
		ads_source.Modify(ls_Modify)
	CASE 61
//		ads_source.Modify( "owner_user.dddw.DisplayColumn = 'user_name'" )
	CASE 64
		//added by gavins 20151014  wait for customer confirm
//		ls_temp2 = ''
//		For ll_i = 1 To  Long( ads_source.describe( "datawindow.column.count" ) ) 
//			ls_temp = ads_source.describe( "#"+string( ll_i ) + ".name" )
//			If ls_temp = 'col_label' Then
//				ls_temp2 += ls_temp + ".height.autosize='yes' " 			
//			Else
//				ls_temp2 += ls_temp + ".height='64~trowheight()' "
//			End If
//			
//		Next
//		If Len( ls_temp2 ) > 0 Then
//			ls_temp2 += "datawindow.detail.height.autosize='yes' "
//			ads_source.Modify( ls_temp2 )
//		End If
	CASE ELSE
		//do nothing
	...
	Case 53
		...
		For i = 1 To UpperBound(ls_button_name[])
			...
			ls_modify_syntax += ' ' + ls_button_name[i] + ".visible='" + ads_source.describe(  Mid(ls_button_name[i],3 ) + ".visible" ) + "' " +  &
				ls_button_name[i] + ".filename = '~~'gRAYflag.bmp~~'~tcase(" +  Mid(ls_button_name[i],3 ) + "_flag when 2  then    ~~'redflag.bmp~~'   when 1  then ~~'greenflag.bmp~~'  else ~~'grayflag.bmp~~' )'" 
		Next
	case 51 //Added By Jay Chen 12-02-2013
		ls_button_name[1] = 't_2'
		ls_modify_syntax += ' ' + ls_button_name[1] + ".visible = false"
	case 52 //Added By Jay Chen 12-03-2013
		ls_modify_syntax += ' ' +  "t_2.visible = false"
//		ls_modify_syntax += ' ' +  "create_date_t.x = 1239"
//		ls_modify_syntax += ' ' +  "create_date.x = 1239" + "create_date.y = 1168"
//		ls_modify_syntax += ' ' +  "b_create_date.x = 1659" + "b_create_date.y = 1168"
//		ls_modify_syntax += ' ' +  "status_by_t.x = 37" + "status_by_t.y = 1264"
//		ls_modify_syntax += ' ' +  "status_by.x = 37" + "status_by.y = 1332"
//		ls_modify_syntax += ' ' +  "status_date_t.x = 1239" + "status_date_t.y = 1264"
//		ls_modify_syntax += ' ' +  "status_date.x = 1239" + "status_date.y = 1332"
//		ls_mdify_syntax += ' ' +  "b_status_date.x = 1659" + "b_status_date.y = 1328"
		ls_button_name[1] = 'b_custom_date1'//added by gavins 2014-07-04
		ls_button_name[2] = 'b_custom_date2'
		ls_button_name[3] = 'b_custom_date3'
		ls_button_name[4] = 'b_custom_date4'
		ls_button_name[5] = 'b_custom_date5'
		ls_button_name[6] = 'b_custom_date6'
		ls_button_name[7] = 'b_checkout_date'
		ls_button_name[8] = 'b_received_date'		
...
ls_tab_name[61] = 'tabpage_windows'
ls_tab_name[62] = 'tabpage_windows'
ls_tab_name[63] = 'tabpage_windows'
ls_tab_name[64] = 'tabpage_windows'
ls_tab_name[65] = 'tabpage_windows'
...
//Added By Jay Chen 06-09-2014
ls_screen_name[61] ='Other Windows->Request WebForm->Browse->Search Criteria'	
ls_screen_name[62] ='Other Windows->Request WebForm->Browse->Request Form Browse'
ls_screen_name[63] ='Other Windows->Request WebForm->Details->Request Webform Header'	
ls_screen_name[64] ='Other Windows->Request WebForm->Details->Request Webform Detail'	
ls_screen_name[65] ='Other Windows->Request WebForm->Details->Request Webform Log'	
...
//Added By Jay Chen 06-09-2014
ls_dw_name[61] = 'dw_search'
ls_dw_name[62] = 'dw_list'
ls_dw_name[63] = 'dw_header'
ls_dw_name[64] = 'dw_detail'
ls_dw_name[65] = 'dw_log'
...
ls_dataobject[60] = ''	
//Added By Jay Chen 06-09-2014
ls_dataobject[61] = 'd_request_webform_query'	
ls_dataobject[62] = ''	
ls_dataobject[63] = 'd_request_webform'	
ls_dataobject[64] = ''	
ls_dataobject[65] = 'd_request_webform_log'	
...
//Added By Jay Chen 06-09-2014
ls_GridDataObject[62] = 'd_request_webform_list'	
ls_GridDataObject[64] = 'd_request_webform_detail'	
				...
				DO
					...
					End If
					 ...
					 For li_k = 1 To li_Cycle
						...
						//Added By Jay Chen 03-17-2015 update ddlb initial value
						of_update_field_initial(lds_target,lds_source)
...
String 	ls_association2, ls_association2_t
...
If al_screen_id = 1 Then
	...
	//Begin - Added By Gavin.Jay 2017-02-27  fix bug for column ccci_association2_t visible
	ls_Modify = ""
	ls_association2 = lds_target.Describe( 'ccci_association2.visible')
	ls_association2_t = lds_target.Describe( 'ccci_association2_t.visible')
	if (ls_association2 = '' or ls_association2 = '0' or ls_association2 = '?') and ls_association2_t = '1' Then
		ls_Modify = " ccci_association2_t.visible = '0' "		
		ls_err = lds_target.Modify( ls_Modify )
		If len( ls_err ) = 0 then 
			ls_SynTax_new = lds_target.Describe( "datawindow.syntax" )		
			lds_Test = Create DataStore
			lds_Test.Create( ls_SynTax_new , ls_err )
			If len( ls_err ) = 0 then 
				ls_SynTax= ls_SynTax_new	
			End If			
		End If		
	End if
	//End - Added By Gavin.Jay 2017-02-27
...
Select set_18,set_patch_ver,screen_version 
Into :ls_main_version, :ls_patch_version, :ls_screen_version 
From icred_settings;

//Begin - Added By Mark Lee 11/05/2012
//If ls_main_version > '110' or ( ls_main_version = '110' and ls_patch_version >= '010'  and ls_screen_version >= '0052' ) Then
//	Return  0
//End If
If ls_main_version > '110' or ( ls_main_version = '110' and ls_patch_version >= '010'  and ls_screen_version >= '0052' ) Then
//	Return  0
...
//Added By Mark Lee 06/06/2016
lds_standobjects = Create Datastore
lds_standobjects.dataobject = "d_dw_standobjects"
...
if lds_standobjects.find( "object_name='"+Mid( as_syntax, ll_LastPos + 2, Pos( as_syntax, '(' , ll_LastPos+ 2 ) -  ll_LastPos - 1 )+"' ",1, lds_standobjects.rowcount()) = 0 then 
	For   li_i = 1 To 100
...
If ll_LastPos <=0 Then 
	...
	END iF
	if isvalid(lds_standobjects) then destroy lds_standobjects
	return -1
end if
...
//	If Pos (ls_Standobjects ,  Mid( ls_s_mid, ll_Pos + 2, Pos( ls_s_mid, '(' , ll_Pos+ 2 ) -  ll_Pos  - 1 ) ) = 0 Then
	if lds_standobjects.find( "object_name='"+Mid( ls_s_mid, ll_Pos + 2, Pos( ls_s_mid, '(' , ll_Pos+ 2 ) -  ll_Pos  - 1 ) +"' ",1, lds_standobjects.rowcount()) = 0 then 
		ll_Pos ++
		continue
	else
...
Long					ll_Row, ll_Count, ll_ID, ll_sObjcount
...
//force update if it's necessary
if Len(as_forceupdate) > 0 then 
	ls_Err = ads_target.Modify(as_forceupdate)
	If Len( ls_Err ) > 0 Then
		//MessageBox( 'Tips', ls_Err )
		gnv_debug.of_output( true, 'The of_update_changeobject() method is failure, as_forceupdate =' + as_forceupdate + ', error=' + ls_Err )
	End If
end if
...
For li_k =1 To lds_target.Rowcount( )
	...
	If  IsNull( ls_temp ) Or Trim( ls_temp ) = '' Then Continue
	if lower(left(ls_temp,6)) = 'object' and lower(right(ls_temp,2)) = '_c' then continue //Added By Jay Chen 07-14-2015 copyed checkbox column can not delete
	li_Find = lds_source.Find( "name = '" + ls_temp + "'",1, lds_source.RowCount( ))
	If li_Find = 0 Then
...
do while ll_pos  > 0 
	If  Mid( ls_Content, ll_Pos+1 , 1 ) = '"' Then
		...
		do while ll_Pos2 > 0 
			...
			End If
		loop
		if ll_Pos2 < ll_Pos then 			//Added By Mark Lee 06/07/2016
			gnv_debug.of_output( true, 'Executed the of_setobjectattribute_value() method was failured, as_content:' + as_Content + ', error= dead cycling.'  )	
			Exit
		end if 
		ll_Pos = ll_Pos2
	Else
...
public function integer of_update_field_initial (datastore ads_target, datastore ads_source);//====================================================================
// Function: of_update_field_initial
//--------------------------------------------------------------------
// Description:
//--------------------------------------------------------------------
// Arguments:
// 	value    datastore    ads_target
// 	value    datastore    ads_source
//--------------------------------------------------------------------
// Returns:  integer
//--------------------------------------------------------------------
// Author:	Jay Chen		Date: 03-17-2015
//--------------------------------------------------------------------
...
//
//====================================================================
long ll_column_count,ll_index
string ls_colname,ls_initial_value,ls_Modify

ll_column_count = long(ads_target.object.datawindow.column.count)

FOR ll_index = 1 TO ll_column_count
	ls_colname = ads_target.describe("#" +STRING(ll_index) + ".Name")
	ls_initial_value = ads_target.describe(ls_colname + ".Initial")
	if not isnull(ls_initial_value) and ls_initial_value <> '' and ls_initial_value <> '!' and ls_initial_value <> '?'  then
		ls_Modify += ls_colname + ".Initial = '" + String(ls_initial_value) + "'"
	end if 
NEXT
