...
IF SQLCA.SQLCODE = -1 THEN 
	...
	IF IsValid(gnv_debug) THEN gnv_debug.of_output(true,"of_get_image_file(): " + ls_Error + " Sql error text: " +  Sqlca.SQLErrText)
...
If lds_d_ctx_am_document.update() <> 1 Then 
	...
	IF IsValid(gnv_debug) THEN gnv_debug.of_output(true,"of_update_support_doc(): " + ls_Error + " Sql error text: " +  Sqlca.SQLErrText)
	gb_upgrade_failed = TRUE
	/*
	ls_Error = '~r~n' + "==================================================="
