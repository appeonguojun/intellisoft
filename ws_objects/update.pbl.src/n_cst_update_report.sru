...
//rpt_path = gs_sysrunpath + "\reports_v95.txt"
//wiz_path = gs_sysrunpath + "\report_wiz_v95.txt"
IF appeongetclienttype() = 'WEB' THEN 
	...
	END IF
ELSE 
	rpt_path = Gs_Current_Directory + "\reports_v95.txt"				//Modified by Scofield on 2008-06-11
	wiz_path = Gs_Current_Directory + "\report_wiz_v95.txt"			//Modified by Scofield on 2008-06-11
END IF
//-------End Modified --------------------------------
...
IF FileExists(rpt_path) = True THEN
	...
	ELSE
		...
		/*
		//==============================APPEON BEGIN==========================
		// $<Modified>:   Date: Nov 12,2007       Author:Nova
		ls_Error = '~r~n' + "==================================================="
