...
//li_value = GetFileOpenName (as_title, as_pathname, as_filename, as_ext, as_filter) 		//Added By Mark Lee 08/15/2014
n_getfilename     ln_getfilename
li_value = ln_getfilename.of_getopenfilename(as_title, as_pathname, as_filename, as_ext, as_filter) 
...
//	li_value = GetFileSaveName (as_title, as_pathname, as_filename, as_ext, as_filter) 
	li_value = ln_getfilename.of_getsavefilename(as_title, as_pathname, as_filename, as_ext, as_filter) 
	gf_save_dir_path(as_pathname) //Added by Ken.Guo on 2009-03-10
	//ChangeDirectory(gs_current_path) //Add by Evan 12/11/2008
