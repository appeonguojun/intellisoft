...
//
//////////////////////////////////////////////////////////////////////////////
string	ls_ObjString, ls_ObjHolder, ls_Visible 
...
Do While li_Tab > 0
	...
	ls_Visible = idw_Requestor.Describe(ls_ObjHolder + ".visible")//modify by gavins 20120621 apb bug
	...
	If (idw_Requestor.Describe(ls_ObjHolder + ".type") = as_ObjType Or as_ObjType = "*") And &
		...
		(ls_Visible  = "1" Or ls_Visible = "-1" Or Not ab_VisibleOnly) Then
			li_Count ++
