...
//li_rtn = GetFileOpenName("Select Location of intellicred.ini file",    docpath, docname[], "INI",  + "Config Files (*.INI),*.INI")
li_rtn = ln_getfilename.of_getopenfilename("Select Location of intellicred.ini file",    docpath, docname[], "INI",  + "Config Files (*.INI),*.INI")
