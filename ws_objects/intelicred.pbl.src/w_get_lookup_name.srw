...
event clicked;MessageBox("Lookup Table help"," 1) Enter the name of the table.~n 2) Select lookup type. ~n~n Address type is for entity lookups ie. Schools, Hospitals;~n Code type is for list items ie. specialties, departments, states. ")
end event
