...
integer width = 1673
integer height = 896
string title = "AD Verification Settings"
...
type variables
n_cst_encrypt in_encrypt //Added By Ken.Guo 2017-03-24 Task 753
end variables
...
//Modified By Ken.Guo 2017-03-24. Task 753
String ls_pwd
ls_pwd = gnv_user_option.of_get_option_value('ad_verify_pwd_encrypt')
If ls_pwd <> '' Then
	sle_pwd.text = in_encrypt.of_decrypt( ls_pwd )
End If
...
//Modified By Ken.Guo 2017-03-24 Task 753
String ls_pwd_enc
ls_pwd_enc = in_encrypt.of_encrypt(  sle_pwd.text )
