...
Choose Case as_tag
	...
	Case 'outlook'
		...
		Messagebox('Contract Logix', 'During the import, the MS Outlook may pop up a message box. Please always click the Allow button.')		//Added By Mark Lee 07/12/2013
		Try
...
//+ docname, named, 'MSG', "Outlook Message Format(*.MSG),*.MSG")			//Added By Mark Lee 08/15/2014
