...
ls_hpath = gs_dir_path + gs_DefDirName + "\intellisite\exports\" + ls_docid + "_header.txt"
...
ls_spath = gs_dir_path + gs_DefDirName + "\intellisite\exports\" + ls_docid + "_survey.txt"
...
p1 =  POS( Message.StringParm, "*" )
p2 =  POS( Message.StringParm, "**" )
//Messagebox("",Message.StringParm)
ls_email_address = Mid( Message.StringParm, 1, p1 - 1)
//Messagebox("addr",ls_email_address)
ls_subject = Mid( Message.StringParm, p1 + 1, p2 - p1 - 1 )
//Messagebox("sub",ls_subject)
ls_notetext = Mid( Message.StringParm, POS( Message.StringParm, "**" ) + 2)
