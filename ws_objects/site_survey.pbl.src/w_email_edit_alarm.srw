...
For i = 1 To ll_max
	...
	If i <> 1 Then gnv_debug.of_output(False, 'Failed to delete the ' + is_filepath + '\' + as_filename + "*." + as_fileext + ' file. Now using ' + as_filename + String(i) +  "." + as_fileext + '.') //Added By Jay Chen 08-04-2014
	Return ls_FileName
...
event close;If IsValid( iole_Word ) Then 
	iole_Word.quit(0)//modified by gavins 20140414  add parameter "0"
	iole_Word.disconnectobject( )
	Destroy( iole_Word )
End If
