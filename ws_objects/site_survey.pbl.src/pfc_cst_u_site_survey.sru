...
type cb_1 from u_cb within pfc_cst_u_site_survey
end type
...
if tab_survey.tabpage_groups.dw_grouping.rowcount() < 1 then return 1
t = tab_survey.tabpage_groups.dw_grouping.getitemnumber(1,"tot_points")
p = tab_survey.tabpage_groups.dw_grouping.getitemnumber(1,"tot_pass")
//messagebox("",i)
tab_survey.tabpage_survey.dw_survey.setitem(1,"total_points",t)
tab_survey.tabpage_survey.dw_survey.setitem(1,"minimum_passing_score",p)
...
li_cr = idw_current.GetRow()
idw_current.InsertRow( li_cr )
idw_current.SetRow( li_cr )
idw_current.ScrollToRow( li_cr )
idw_current.SetFocus()

IF idw_current = dw_answers THEN
	idw_current.SetColumn("question_answer")
ELSE
	idw_current.SetColumn("group_id")
END IF
