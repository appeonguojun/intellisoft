...
Choose Case iu_message.msgicon
		Case 'Information'
			p_3.picturename = 'info.gif' 
		Case 'StopSign'
			p_3.picturename = 'error.gif' 
		Case 'Exclamation'
			p_3.picturename = 'warning.gif' 
		Case 'Question'
			p_3.picturename = 'quest.bmp' 
		case else
			p_3.visible=false
End Choose
//default
...
integer height = 96
boolean originalsize = true
string picturename = ".\helpicon.gif"
