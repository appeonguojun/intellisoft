...
public subroutine f_showmessage (string as_title, string as_error, string as_representation, string as_cause);String ls_wf_name
...
event open;call super::open;f_showmessage(iu_message.msgtitle,iu_message.msgtext,iu_message.msgrepresentation,iu_message.msgcause)
end event
...
integer height = 56
boolean bringtotop = true
string picturename = ".\downright.bmp"
boolean focusrectangle = false
end type
