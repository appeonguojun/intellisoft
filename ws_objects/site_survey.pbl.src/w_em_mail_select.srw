...
event pfc_preopen;call super::pfc_preopen;inv_pop3 = Create n_cst_easymail_pop3  //Added By Ken.Guo 2015-07-27
end event

event close;call super::close;If isvalid(inv_pop3) Then Destroy inv_pop3 //Added By Ken.Guo 2015-07-27
end event
...
If Lower(ls_ext) <> Lower(istr_ctx_email.doc_ext ) and (Pos(Lower(istr_ctx_email.doc_ext ) + 'x',  Lower(ls_ext)) <= 0) Then	//Modified by harry 2017-01-06
