...
//ls_customscreen = {'custom_date1','custom_date2','custom_date3','custom_date4','custom_date5','custom_date6','custom_date7','custom_date8','custom_date9','custom_date10'} //Modified By Jay Chen 11-27-2013
...
long 		ll_i
long 		ll_rowcount,	ll_ctx_id, ll_hdr_id, i 
string		ls_sql[]
integer 	li_return
...
//	ib_retrieved = false
	...
	if isvalid(lpo_parent) then 
		...
		luo_contract.tab_multi.tabpage_detail.event ue_reset_ib_retrieve( )
	end if 
end if 
...
//ll_ctx_id = inv_contract_details.Of_get_ctx_id( )
//delete ctx_custom_multi_detail where ctx_id = :ll_ctx_id and hdr_id = :ll_hdr_id;					//Added By Mark Lee 10/26/2015
//Added By Mark Lee 06/14/2013 record to the log of delete in the table sys_audit for the contract multi header.
//this.rowscopy(  this.GetRow(), this.GetRow(), Primary!, this,1, Delete!)									//Added By Mark Lee 10/26/2015
Super::Event pfc_deleteRow()								//move it 
Super::Event updateend(0,0,this.GetRow())

//Super::Event pfc_deleteRow()											//Added By Mark Lee 10/26/2015
//this.Update( )																	//Added By Mark Lee 10/26/2015  change save the delete.
