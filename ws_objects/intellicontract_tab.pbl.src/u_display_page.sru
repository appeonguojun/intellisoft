$PBExportHeader$u_display_page.sru
forward
global type u_display_page from userobject
end type
type pb_4 from picturebutton within u_display_page
end type
type pb_3 from picturebutton within u_display_page
end type
type sle_page from singlelineedit within u_display_page
end type
type pb_2 from picturebutton within u_display_page
end type
type pb_1 from picturebutton within u_display_page
end type
end forward
...
global u_display_page u_display_page

on u_display_page.create
