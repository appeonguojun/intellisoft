...
ll_OrignalBY = Long( dw_1.Describe( "b_insert.y" ) ) //added by gavins 20151126
...
If ll_OrignalBY > ll_NoteY + 50 Then  dw_1.Modify("b_insert.Y = " + String(ll_NoteY + ll_NoteHeight - ll_BHeight))  //modify by gavins 20151126
