$PBExportHeader$n_cst_dropdown2.sru
$PBExportComments$Extension DropDown Service
forward
global type n_cst_dropdown2 from pfc_n_cst_dropdown
end type
end forward

global type n_cst_dropdown2 from pfc_n_cst_dropdown
end type
global n_cst_dropdown2 n_cst_dropdown2
...
If adrg_object.TypeOf() = datawindow! Then
	...
	idec_zoom = ldec_zoom //Added By Jay Chen 01-21-2016
...
on n_cst_dropdown2.create
call super::create
end on

on n_cst_dropdown2.destroy
call super::destroy
end on
