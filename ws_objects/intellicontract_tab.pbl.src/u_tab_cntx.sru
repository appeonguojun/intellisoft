...
type tabpage_custom_facility from u_tabpg_cntct_custom_facility within u_tab_cntx
end type
type tabpage_custom_facility from u_tabpg_cntct_custom_facility within u_tab_cntx
end type
end forward
...
tabpage_custom_facility tabpage_custom_facility
end type
...
this.tabpage_custom_facility=create tabpage_custom_facility
int iCurrent
call super::create
...
this.Control[iCurrent+5]=this.tabpage_custom_facility
end on
...
destroy(this.tabpage_custom_facility)
end on
...
this.tabpage_custom_facility.of_accepttext(false) //Added By Jay Chen 08-06-2015
...
//	if OLDindex = 1 and NEWindex = 2 or OLDindex = 1 and NEWindex = 3 or OLDindex = 3 and NEWindex = 2 then
	if OLDindex = 1 and NEWindex = 2 or OLDindex = 1 and NEWindex = 3 or OLDindex = 3 and NEWindex = 2 or (OLDindex = 1 and NEWindex = 5) or (OLDindex = 5 and NEWindex = 2) then //Modified By Jay Chen 08-06-2015
...
if newindex > 1 and is_mode <> 'NEW' then
	...
	elseif newindex = 5 then
		this.tabpage_custom_facility.dw_2.Modify("datawindow.readonly = " + ls_readonly ) //Added By Jay Chen 08-06-2015
...
This.Selecttab(5) //Added By Jay Chen 08-06-2015
