...
IF ln_getfilename.of_getsavefilename("Select a file",docname, named, "All Files", + "All Files (*.*),*.*") = 1 THEN 
...
case 'b_open'
		 ...
		 */
		 value = ShellExecuteA ( Handle( This ), "open", 'IEXPLORE', string(object.ctx_file_location_path[row]), ls_Null, 4)
		 //---------------------------- APPEON END ----------------------------   		
		choose case value
			case 0 
