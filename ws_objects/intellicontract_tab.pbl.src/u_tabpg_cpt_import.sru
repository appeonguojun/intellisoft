...
if ln_getfilename.of_getopenfilename("Open text file for import", ls_path, named, "txt", "Text Files (*.TXT),*.TXT") = 1 then
	is_doc_path = ls_path
else
	is_doc_path = ''
end if
...
event clicked;call super::clicked;Of_database( )
end event
