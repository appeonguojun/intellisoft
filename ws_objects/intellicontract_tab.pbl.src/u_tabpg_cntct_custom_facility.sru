$PBExportHeader$u_tabpg_cntct_custom_facility.sru
forward
global type u_tabpg_cntct_custom_facility from u_tabpg
end type
type dw_2 from u_dw_contract within u_tabpg_cntct_custom_facility
end type
end forward
...
global u_tabpg_cntct_custom_facility u_tabpg_cntct_custom_facility

type variables

end variables

on u_tabpg_cntct_custom_facility.create
int iCurrent
call super::create
...
on u_tabpg_cntct_custom_facility.destroy
call super::destroy
destroy(this.dw_2)
end on
...
string title = "User Defined Company Data"
string dataobject = "d_cntx_custom_facility"
end type
...
if w_contract_contact.tab_1.Tabpage_details.ib_IsValid then //Modified By Jay Chen 08-05-2015
	w_contract_contact.tab_1.Tabpage_details.dw_3 = w_contract_contact.tab_1.Tabpage_details.dw_3
	w_contract_contact.tab_1.Tabpage_details.dw_facility_detail.ShareData(w_contract_contact.tab_1.Tabpage_details.dw_3)
end if
